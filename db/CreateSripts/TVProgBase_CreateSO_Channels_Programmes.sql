...
begin
	...
	begin
	    begin try
	        ...
	        insert into dbo.MediaPic (FileName, ContentType, ContentCoding, ContentOrig, Length, 
			                                                                Content25, Length25, IsSystem)
			values (@ChannelIconName, @ContentType, @ContentCoding, @ChannelOrigIcon, @LengthIcon, 
			                                        @ChannelIcon25, @Length25Icon, @IsSystem);
	    end try
	    begin catch
			set @ErrCode = 75;
	    end catch
