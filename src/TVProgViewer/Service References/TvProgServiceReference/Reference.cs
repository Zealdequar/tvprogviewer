...
namespace TVProgViewer.TVProgApp.TvProgServiceReference {
    ...
    public interface IMainService {
        ...
        void InsertUserChannel(int userChannelID, long uid, int typeProgID, int cid, string displayName, int orderCol);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMainService/InsertUserChannel", ReplyAction="http://tempuri.org/IMainService/InsertUserChannelResponse")]
        System.Threading.Tasks.Task InsertUserChannelAsync(int userChannelID, long uid, int typeProgID, int cid, string displayName, int orderCol);
        ...
        TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[] GetUserProgrammeList(long uid, int typeProgID, System.DateTimeOffset dateTimeOffset, int mode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMainService/GetUserProgrammeList", ReplyAction="http://tempuri.org/IMainService/GetUserProgrammeListResponse")]
        System.Threading.Tasks.Task<TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[]> GetUserProgrammeListAsync(long uid, int typeProgID, System.DateTimeOffset dateTimeOffset, int mode);
        ...
        TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[] GetUserProgrammeDayList(long uid, int typeProgID, int cid, System.DateTime tsStart, System.DateTime tsStop);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMainService/GetUserProgrammeDayList", ReplyAction="http://tempuri.org/IMainService/GetUserProgrammeDayListResponse")]
        System.Threading.Tasks.Task<TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[]> GetUserProgrammeDayListAsync(long uid, int typeProgID, int cid, System.DateTime tsStart, System.DateTime tsStop);
    }
    ...
    public partial class MainServiceClient : System.ServiceModel.ClientBase<TVProgViewer.TVProgApp.TvProgServiceReference.IMainService>, TVProgViewer.TVProgApp.TvProgServiceReference.IMainService {
        ...
        public void InsertUserChannel(int userChannelID, long uid, int typeProgID, int cid, string displayName, int orderCol) {
            base.Channel.InsertUserChannel(userChannelID, uid, typeProgID, cid, displayName, orderCol);
        }
        
        public System.Threading.Tasks.Task InsertUserChannelAsync(int userChannelID, long uid, int typeProgID, int cid, string displayName, int orderCol) {
            return base.Channel.InsertUserChannelAsync(userChannelID, uid, typeProgID, cid, displayName, orderCol);
        }
        ...
        public TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[] GetUserProgrammeList(long uid, int typeProgID, System.DateTimeOffset dateTimeOffset, int mode) {
            return base.Channel.GetUserProgrammeList(uid, typeProgID, dateTimeOffset, mode);
        }
        
        public System.Threading.Tasks.Task<TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[]> GetUserProgrammeListAsync(long uid, int typeProgID, System.DateTimeOffset dateTimeOffset, int mode) {
            return base.Channel.GetUserProgrammeListAsync(uid, typeProgID, dateTimeOffset, mode);
        }
        
        public TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[] GetUserProgrammeDayList(long uid, int typeProgID, int cid, System.DateTime tsStart, System.DateTime tsStop) {
            return base.Channel.GetUserProgrammeDayList(uid, typeProgID, cid, tsStart, tsStop);
        }
        
        public System.Threading.Tasks.Task<TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[]> GetUserProgrammeDayListAsync(long uid, int typeProgID, int cid, System.DateTime tsStart, System.DateTime tsStop) {
            return base.Channel.GetUserProgrammeDayListAsync(uid, typeProgID, cid, tsStart, tsStop);
        }
    }
}
