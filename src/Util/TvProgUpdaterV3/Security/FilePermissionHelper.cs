...
namespace TvProgViewer.TvProgUpdaterV3.Security
{
    /// <summary>
    ...
    public static class FilePermissionHelper
    {
        ...
        [SupportedOSPlatform("windows")]
        private static bool CheckPermissionsInWindows(ITvProgFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
        {
        ...
        /// <param name="checkDelete">Check delete</param>
        /// <returns>Result</returns>
        public static bool CheckPermissions(this ITvProgFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
        {
        ...
        /// </summary>
        /// <returns>Result</returns>
        public static IEnumerable<string> GetDirectoriesWrite(this ITvProgFileProvider fileProvider)
        {
        ...
        /// </summary>
        /// <returns>Result</returns>
        public static IEnumerable<string> GetFilesWrite(this ITvProgFileProvider fileProvider)
        {
            return new List<string>
            {
                fileProvider.MapPath(TvProgPluginDefaults.PluginsInfoFilePath),
                fileProvider.MapPath(TvProgConfigurationDefaults.AppSettingsFilePath)
            };
        }
