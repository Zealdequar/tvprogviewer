...
using TvProgViewer.TvProgUpdaterV3.WebOptimizer;
using TvProgViewer.TvProgUpdaterV3.WebOptimizer.Processors;
using WebOptimizer;

namespace TvProgViewer.TvProgUpdaterV3.UI
{
    /// <summary>
    /// Represents the HTML helper implementation
    /// </summary>
    public partial class TvProgHtmlHelper : ITvProgHtmlHelper
    {
        #region Fields
        ...
        public TvProgHtmlHelper(AppSettings appSettings,
        ...
        private IAsset CreateCssAsset(string bundleKey, string[] assetFiles)
        {
            ...
            asset.Processors.Add(new TvProgCssMinifier());
        ...
        private IAsset CreateJavaScriptAsset(string bundleKey, string[] assetFiles)
        {
            ...
            //to more precisely log problem files we minify them before concatenating
            asset.Processors.Add(new TvProgJsMinifier());
        ...
        public virtual string GetRouteName(bool handleDefaultRoutes = false)
        {
            ...
            if (httpContext.GetRouteValue(TvProgRoutingDefaults.RouteValue.SeName) is not null &&
                httpContext.GetRouteValue(TvProgRoutingDefaults.RouteValue.Action) is string actionName)
                return actionName;
