...
namespace TvProgViewer.TvProgUpdaterV3.TagHelpers.Public
{
    /// <summary>
    /// "tvprog-bb-code-editor" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-bb-code-editor", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public partial class TvProgBBCodeEditorTagHelper : TagHelper
    {
        #region Constants
        ...
        public TvProgBBCodeEditorTagHelper(IWebHelper webHelper)
        {
