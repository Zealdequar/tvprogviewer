...
{
    /// <summary>
    /// "tvprog-editor" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-editor", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public partial class TvProgEditorTagHelper : TagHelper
    {
        #region Constants
        ...
        public TvProgEditorTagHelper(IHtmlHelper htmlHelper)
        {
