...
{
    /// <summary>
    /// "tvprog-card" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-card", Attributes = NAME_ATTRIBUTE_NAME)]
    public partial class TvProgCardTagHelper : TagHelper
    {
        #region Constants
        ...
        public TvProgCardTagHelper(IHtmlHelper htmlHelper)
        {
