...
{
    /// <summary>
    /// "tvprog-alert" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-alert", Attributes = ALERT_NAME_ID, TagStructure = TagStructure.WithoutEndTag)]
    public partial class TvProgAlertTagHelper : TagHelper
    {
        #region Constants
        ...
        public TvProgAlertTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
