...
{
    /// <summary>
    /// "tvprog-doc-reference" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-doc-reference", Attributes = STRING_RESOURCE_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public partial class TvProgDocReferenceTagHelper : TagHelper
    {
        #region Constants
        ...
        public TvProgDocReferenceTagHelper(AdminAreaSettings adminAreaSettings)
        {
