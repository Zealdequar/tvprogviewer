...
{
    /// <summary>
    /// "tvprog-action-confirmation" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-action-confirmation", Attributes = BUTTON_ID_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public partial class TvProgActionConfirmationTagHelper : TagHelper
    {
        #region Constants
        ...
        public TvProgActionConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
