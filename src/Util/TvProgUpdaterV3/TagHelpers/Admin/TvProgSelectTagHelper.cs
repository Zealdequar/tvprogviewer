...
{
    /// <summary>
    /// "tvprog-select" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-select", TagStructure = TagStructure.WithoutEndTag)]
    public partial class TvProgSelectTagHelper : TagHelper
    {
        #region Constants
        ...
        public TvProgSelectTagHelper(IHtmlHelper htmlHelper)
        {
