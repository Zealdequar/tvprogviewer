...
{
    /// <summary>
    /// "tvprog-delete-confirmation" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-delete-confirmation", Attributes = MODEL_ID_ATTRIBUTE_NAME + "," + BUTTON_ID_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public partial class TvProgDeleteConfirmationTagHelper : TagHelper
    {
        #region Constants
        ...
        public TvProgDeleteConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
