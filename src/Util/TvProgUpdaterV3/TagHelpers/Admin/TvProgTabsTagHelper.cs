...
using TvProgViewer.TvProgUpdaterV3.Extensions;

namespace TvProgViewer.TvProgUpdaterV3.TagHelpers.Admin
{
    /// <summary>
    /// "tvprog-tabs" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-tabs", Attributes = ID_ATTRIBUTE_NAME)]
    public partial class TvProgTabsTagHelper : TagHelper
    {
        #region Constants
        ...
        public TvProgTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<TvProgTabContextItem>();
            context.Items.Add(typeof(TvProgTabsTagHelper), tabContext);
    ...
    /// <summary>
    /// "tvprog-tab" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-tab", ParentTag = "tvprog-tabs", Attributes = NAME_ATTRIBUTE_NAME)]
    public partial class TvProgTabTagHelper : TagHelper
    {
        #region Constants
        ...
        public TvProgTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<TvProgTabContextItem>)context.Items[typeof(TvProgTabsTagHelper)];
            tabContext.Add(new TvProgTabContextItem
            {
    ...
    /// Tab context item
    /// </summary>
    public partial class TvProgTabContextItem
    {
        /// <summary>
        /// Title
        /// </summary>
