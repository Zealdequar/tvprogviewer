...
{
    /// <summary>
    /// "tvprog-textarea" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-textarea", Attributes = FOR_ATTRIBUTE_NAME)]
    public partial class TvProgTextAreaTagHelper : TextAreaTagHelper
    {
        #region Constants
        ...
        public TvProgTextAreaTagHelper(IHtmlGenerator generator) : base(generator)
        {
        }
