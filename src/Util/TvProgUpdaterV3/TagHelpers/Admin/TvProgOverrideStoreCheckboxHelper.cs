...
{
    /// <summary>
    /// "tvprog-override-store-checkbox" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-override-store-checkbox", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public partial class TvProgOverrideStoreCheckboxHelper : TagHelper
    {
        #region Constants
        ...
        public TvProgOverrideStoreCheckboxHelper(IHtmlHelper htmlHelper)
        {
