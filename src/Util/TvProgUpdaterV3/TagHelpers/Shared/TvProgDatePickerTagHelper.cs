...
namespace TvProgViewer.TvProgUpdaterV3.TagHelpers.Shared
{
    /// <summary>
    /// "tvprog-date-picker" tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-date-picker", Attributes = DAY_NAME_ATTRIBUTE_NAME + "," + MONTH_NAME_ATTRIBUTE_NAME + "," + YEAR_NAME_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public partial class TvProgDatePickerTagHelper : TagHelper
    {
        #region Constants
