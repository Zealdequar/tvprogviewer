...
namespace TvProgViewer.TvProgUpdaterV3.Events
{
    /// <summary>
    ...
    public partial class PageRenderingEvent
    {
        ...
        public PageRenderingEvent(ITvProgHtmlHelper helper, string overriddenRouteName = null)
        {
            Helper = helper;
        ...
        /// Gets HTML helper
        /// </summary>
        public ITvProgHtmlHelper Helper { get; private set; }
