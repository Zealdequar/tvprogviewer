...
namespace TvProgViewer.TvProgUpdaterV3.Mvc.Routing
{
    /// <summary>
    /// Represents custom overridden redirect result executor
    /// </summary>
    public partial class TvProgRedirectResultExecutor : RedirectResultExecutor
    {
        #region Fields
        ...
        public TvProgRedirectResultExecutor(IActionContextAccessor actionContextAccessor,
