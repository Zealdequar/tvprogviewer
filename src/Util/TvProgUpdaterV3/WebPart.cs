               ...
               if (!String.IsNullOrEmpty(src))
               {
                  try
                  {
                     ...
                     using (MemoryStream ms = new MemoryStream())
                     {
                         ...
                         if (!Directory.Exists(@"\imgs\large"))
                            Directory.CreateDirectory(@"imgs\large");
                     ...
                     using (MemoryStream ms = new MemoryStream())
                     {
                         if (!Directory.Exists(@"\imgs\small"))
                             Directory.CreateDirectory(@"imgs\small");
