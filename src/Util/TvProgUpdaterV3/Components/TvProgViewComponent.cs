...
using TvProgViewer.TvProgUpdaterV3.Events;
using TvProgViewer.TvProgUpdaterV3.Models;
using TvProgViewer.TvProgUpdaterV3.Events;
using TvProgViewer.TvProgUpdaterV3.Models;

namespace TvProgViewer.TvProgUpdaterV3.Components
{
    /// <summary>
    ...
    public abstract partial class TvProgViewComponent : ViewComponent
    {
        private void PublishModelPrepared<TModel>(TModel model)
        {
            ...
            //as we do in the /TvProg.TvProgUpdaterV3/Mvc/Filters/PublishModelEventsAttribute.cs for controllers
