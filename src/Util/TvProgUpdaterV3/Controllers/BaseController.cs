...
namespace TvProgViewer.TvProgUpdaterV3.Controllers
{
    ...
    public abstract partial class BaseController : Controller
    {
        ...
        {
            var nopHtmlHelper = EngineContext.Current.Resolve<ITvProgHtmlHelper>();
        ...
        public virtual void SaveSelectedCardName(string cardName, bool persistForTheNextRequest = true)
        {
            ...
            //"GetSelectedCardName" method of \TvProg.TvProgUpdaterV3\Extensions\HtmlExtensions.cs
        ...
        {
            //keep this method synchronized with
            //"GetSelectedTabName" method of \TvProg.TvProgUpdaterV3\Extensions\HtmlExtensions.cs
