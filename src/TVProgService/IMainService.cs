...
namespace TVProgViewer.TVProgService
{
    ...
    public interface IMainService
    {
        ...
        /// <param name="category">Категория</param>
        [OperationContract]
        List<SystemProgramme> GetUserProgrammeList(long uid, int typeProgID, DateTimeOffset dateTimeOffset, int mode, string category);
        ...
        [OperationContract]
        List<SystemProgramme> SearchProgramme(int typeProgID, string findTitle);
