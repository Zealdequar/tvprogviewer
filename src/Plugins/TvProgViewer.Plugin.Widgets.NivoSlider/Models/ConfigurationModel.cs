...
namespace TvProgViewer.Plugin.Widgets.NivoSlider.Models
{
    public record ConfigurationModel : BaseTvProgModel
    {
        public int ActiveStoreScopeConfiguration { get; set; }
        
        [TvProgResourceDisplayName("Plugins.Widgets.NivoSlider.Picture")]
        [UIHint("Picture")]
        public int Picture1Id { get; set; }
        public bool Picture1Id_OverrideForStore { get; set; }
        [TvProgResourceDisplayName("Plugins.Widgets.NivoSlider.Text")]
        public string Text1 { get; set; }
        public bool Text1_OverrideForStore { get; set; }
        [TvProgResourceDisplayName("Plugins.Widgets.NivoSlider.Link")]
        public string Link1 { get; set; }
        public bool Link1_OverrideForStore { get; set; }
        [TvProgResourceDisplayName("Plugins.Widgets.NivoSlider.AltText")]
