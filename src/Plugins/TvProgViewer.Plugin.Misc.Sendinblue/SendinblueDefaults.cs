...
namespace TvProgViewer.Plugin.Misc.Sendinblue
{
    ...
    public static class SendinblueDefaults
    {
        ...
        /// </summary>
        public static string PartnerName => "tvprogviewer";
        ...
        /// </summary>
        public static string SynchronizationTask => "TvProg.Plugin.Misc.Sendinblue.Services.SynchronizationTask";
        ...
        /// </summary>
        public static string SmartPhoneServiceAttribute => "PHONE";
        ...
        /// </summary>
        public static string BirthDateServiceAttribute => "DATE_OF_BIRTH";
        ...
        /// </summary>
        public static string OrderTotalSumServiceAttribute => "tvprogviewer_CA_USER";

        /// <summary>
        /// Gets a name of attribute to store an order total sum of month
        /// </summary>
        public static string OrderTotalMonthSumServiceAttribute => "tvprogviewer_LAST_30_DAYS_CA";

        /// <summary>
        /// Gets a name of attribute to store an order count
        /// </summary>
        public static string OrderCountServiceAttribute => "tvprogviewer_ORDER_TOTAL";

        /// <summary>
        /// Gets a name of attribute to store all orders total sum
        /// </summary>
        public static string AllOrderTotalSumServiceAttribute => "tvprogviewer_CA_TOTAL";

        /// <summary>
        /// Gets a name of attribute to store all orders total sum of month
        /// </summary>
        public static string AllOrderTotalMonthSumServiceAttribute => "tvprogviewer_CA_LAST_30DAYS";

        /// <summary>
        /// Gets a name of attribute to store all orders count
        /// </summary>
        public static string AllOrderCountServiceAttribute => "tvprogviewer_ORDERS_COUNT";
        ...
        /// </summary>
        public static string SmartPhoneTypeAttribute => "SmartPhoneTypeId";
        ...
        /// <summary>
        /// Gets a token to place user email in the tracking script
        /// </summary>
        public static string TrackingScriptUserEmail => "{CUSTOMER_EMAIL}";
