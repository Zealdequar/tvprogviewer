...
namespace TvProgViewer.Plugin.Misc.Sendinblue.Models
{
    ...
    public record ConfigurationModel : BaseTvProgModel
    {
        ...
        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.ApiKey")]
        public string ApiKey { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.List")]
        public int ListId { get; set; }
        public bool ListId_OverrideForStore { get; set; }
        public IList<SelectListItem> AvailableLists { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.SmtpKey")]
        public string SmtpKey { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.UseSmtp")]
        public bool UseSmtp { get; set; }
        public bool UseSmtp_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.Sender")]
        public string SenderId { get; set; }
        public bool SenderId_OverrideForStore { get; set; }
        public IList<SelectListItem> AvailableSenders { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.UseSmsNotifications")]
        public bool UseSmsNotifications { get; set; }
        public bool UseSmsNotifications_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.SmsSenderName")]
        public string SmsSenderName { get; set; }
        public bool SmsSenderName_OverrideForStore { get; set; }

        [DataType(DataType.PhoneNumber)]
        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.StoreOwnerPhoneNumber")]
        public string StoreOwnerPhoneNumber { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.CampaignList")]
        public int CampaignListId { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.CampaignSenderName")]
        public string CampaignSenderName { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.CampaignText")]
        public string CampaignText { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.MaKey")]
        public string MarketingAutomationKey { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.UseMarketingAutomation")]
        public bool UseMarketingAutomation { get; set; }
        public bool UseMarketingAutomation_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.AccountInfo")]
        public string AccountInfo { get; set; }

        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.AllowedTokens")]
        ...
        [TvProgResourceDisplayName("Plugins.Misc.Sendinblue.Fields.TrackingScript")]
