...
namespace TvProgViewer.Plugin.Misc.Sendinblue.Services
{
    ...
    public class EventConsumer :
        ...
        IConsumer<EntityTokensAddedEvent<User, Token>>
    {
        #region Fields
        ...
        /// <summary>
        /// Handle the user tokens added event
        /// </summary>
        /// <param name="eventMessage">The event message.</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public Task HandleEventAsync(EntityTokensAddedEvent<User, Token> eventMessage)
        {
            //handle event
            eventMessage.Tokens.Add(new Token("User.PhoneNumber", eventMessage.Entity.SmartPhone));
