...
using TvProgViewer.Plugin.Misc.Sendinblue.Models;
...
namespace TvProgViewer.Plugin.Misc.Sendinblue.Controllers
{
    ...
    public class SendinblueController : BasePluginController
    {
        ...
        private async Task PrepareModelAsync(ConfigurationModel model)
        {
            ...
            model.HideGeneralBlock = await _genericAttributeService.GetAttributeAsync<bool>(user, SendinblueDefaults.HideGeneralBlock);
            model.HideSynchronizationBlock = await _genericAttributeService.GetAttributeAsync<bool>(user, SendinblueDefaults.HideSynchronizationBlock);
            model.HideTransactionalBlock = await _genericAttributeService.GetAttributeAsync<bool>(user, SendinblueDefaults.HideTransactionalBlock);
            model.HideSmsBlock = await _genericAttributeService.GetAttributeAsync<bool>(user, SendinblueDefaults.HideSmsBlock);
            model.HideMarketingAutomationBlock = await _genericAttributeService.GetAttributeAsync<bool>(user, SendinblueDefaults.HideMarketingAutomationBlock);
            ...
            model.AddSms.AvailableSmartPhoneTypes.Add(new SelectListItem(await _localizationService.GetResourceAsync("Plugins.Misc.Sendinblue.MySmartPhone"), "0"));
            model.AddSms.AvailableSmartPhoneTypes.Add(new SelectListItem(await _localizationService.GetResourceAsync("Plugins.Misc.Sendinblue.UserSmartPhone"), "1"));
            model.AddSms.AvailableSmartPhoneTypes.Add(new SelectListItem(await _localizationService.GetResourceAsync("Plugins.Misc.Sendinblue.BillingAddressSmartPhone"), "2"));
            model.AddSms.DefaultSelectedSmartPhoneTypeId = model.AddSms.AvailableSmartPhoneTypes.First().Value;
        ...
        public async Task<IActionResult> SMSList(SmsSearchModel searchModel)
        {
            ...
            var model = await new SmsListModel().PrepareToGridAsync(searchModel, messageTemplates, () =>
            {
                return messageTemplates.SelectAwait(async messageTemplate =>
                {
                    var phoneTypeID = await _genericAttributeService.GetAttributeAsync<int>(messageTemplate, SendinblueDefaults.SmartPhoneTypeAttribute);
                    ...
                    //currently supported: "my phone" (filled on the configuration page), user phone, phone of the billing address
                    switch (phoneTypeID)
                    {
                        case 0:
                            smsModel.SmartPhoneType = await _localizationService.GetResourceAsync("Plugins.Misc.Sendinblue.MySmartPhone");
                            break;
                        case 1:
                            smsModel.SmartPhoneType = await _localizationService.GetResourceAsync("Plugins.Misc.Sendinblue.UserSmartPhone");
                            break;
                        case 2:
                            smsModel.SmartPhoneType = await _localizationService.GetResourceAsync("Plugins.Misc.Sendinblue.BillingAddressSmartPhone");
                            break;
                        default:
                            break;
                    }
        ...
        public async Task<IActionResult> SMSAdd(SmsModel model)
        {
            ...
            if (message != null)
            {
                ...
                await _genericAttributeService.SaveAttributeAsync(message, SendinblueDefaults.SmartPhoneTypeAttribute, model.SmartPhoneTypeId);
            }
        ...
        public async Task<IActionResult> SMSDelete(SmsModel model)
        {
            ...
            if (message != null)
            {
                ...
                await _genericAttributeService.SaveAttributeAsync<int?>(message, SendinblueDefaults.SmartPhoneTypeAttribute, null);
            }
        ...
        public async Task<IActionResult> ImportContacts(BaseTvProgModel model, IFormCollection form)
        {
            try
            {
                //logging info
