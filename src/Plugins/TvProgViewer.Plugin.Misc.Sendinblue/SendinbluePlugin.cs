...
using TvProgViewer.Plugin.Misc.Sendinblue.Components;
...
namespace TvProgViewer.Plugin.Misc.Sendinblue
{
    /// <summary>
    ...
    public class SendinbluePlugin : BasePlugin, IMiscPlugin, IWidgetPlugin
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            await _settingService.SaveSettingAsync(new SendinblueSettings
            {
                ...
                <script>
                    (function() {{
                        ...
                        window.sib.email_id = '{SendinblueDefaults.TrackingScriptUserEmail}';
            ...
            await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                ["Plugins.Misc.Sendinblue.ActivateSMTP"] = "On your Sendinblue account, the SMTP has not been enabled yet. To request its activation, simply send an email to our support team at contact@sendinblue.com and mention that you will be using the SMTP with the tvProgViewer plugin.",
                ["Plugins.Misc.Sendinblue.AddNewSMSNotification"] = "Add new SMS notification",
                ["Plugins.Misc.Sendinblue.BillingAddressSmartPhone"] = "Billing address phone number",
                ["Plugins.Misc.Sendinblue.UserSmartPhone"] = "User phone number",
                ...
                ["Plugins.Misc.Sendinblue.Fields.List.Hint"] = "Select the Sendinblue list where your tvProgViewer newsletter subscribers will be added.",
                ...
                ["Plugins.Misc.Sendinblue.Fields.TrackingScript.Hint"] = $"Paste the tracking script generated by Sendinblue here. {SendinblueDefaults.TrackingScriptId} and {SendinblueDefaults.TrackingScriptUserEmail} will be dynamically replaced.",
                ...
                ["Plugins.Misc.Sendinblue.MySmartPhone"] = "Store owner phone number",
                ["Plugins.Misc.Sendinblue.SmartPhoneType"] = "Type of phone number",
                ["Plugins.Misc.Sendinblue.SmartPhoneType.Hint"] = "Specify the type of phone number to send SMS.",
