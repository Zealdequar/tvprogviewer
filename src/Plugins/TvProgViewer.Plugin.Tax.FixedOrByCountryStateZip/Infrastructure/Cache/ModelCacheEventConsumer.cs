...
namespace TvProgViewer.Plugin.Tax.FixedOrByCountryStateZip.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeletedEvent<TaxCategory>>
    {
        ...
        /// </summary>
        public static CacheKey ALL_TAX_RATES_MODEL_KEY = new("TvProg.plugins.tax.fixedorbycountrystateziptaxrate.all", TAXRATE_PATTERN_KEY);
        public static CacheKey TAXRATE_ALL_KEY = new("TvProg.plugins.tax.fixedorbycountrystateziptaxrate.taxrate.all", TAXRATE_PATTERN_KEY);
        
        public const string TAXRATE_PATTERN_KEY = "TvProg.plugins.tax.fixedorbycountrystateziptaxrate.";
