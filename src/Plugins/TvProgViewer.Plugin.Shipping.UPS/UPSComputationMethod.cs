...
namespace TvProgViewer.Plugin.Shipping.UPS
{
    /// <summary>
    ...
    public class UPSComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            {
                UseSandbox = true,
                UserClassification = UserClassification.StandardListRates,
            ...
            {
                ["Enums.TvProg.Plugin.Shipping.UPS.PackingType.PackByDimensions"] = "Pack by dimensions",
                ["Enums.TvProg.Plugin.Shipping.UPS.PackingType.PackByOneItemPerPackage"] = "Pack by one item per package",
                ["Enums.TvProg.Plugin.Shipping.UPS.PackingType.PackByVolume"] = "Pack by volume",
                ...
                ["Plugins.Shipping.UPS.Fields.AdditionalHandlingCharge.Hint"] = "Enter additional handling fee to charge your users.",
                ["Plugins.Shipping.UPS.Fields.AvailableCarrierServices"] = "Carrier Services",
                ["Plugins.Shipping.UPS.Fields.AvailableCarrierServices.Hint"] = "Select the services you want to offer to users.",
                ["Plugins.Shipping.UPS.Fields.UserClassification"] = "UPS User Classification",
                ["Plugins.Shipping.UPS.Fields.UserClassification.Hint"] = "Choose user classification.",
        ...
        public override async Task UninstallAsync()
        {
            ...
            //locales
            await _localizationService.DeleteLocaleResourcesAsync("Enums.TvProg.Plugin.Shipping.UPS");
