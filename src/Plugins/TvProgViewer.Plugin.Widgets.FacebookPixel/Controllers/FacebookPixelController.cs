...
namespace TvProgViewer.Plugin.Widgets.FacebookPixel.Controllers
{
    ...
    public class FacebookPixelController : BasePluginController
    {
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            model.FacebookPixelSearchModel.HideSearchBlock = await _genericAttributeService
                .GetAttributeAsync<bool>(await _workContext.GetCurrentUserAsync(), FacebookPixelDefaults.HideSearchBlockAttribute);
