...
using TvProgViewer.Plugin.Widgets.FacebookPixel.Components;
...
namespace TvProgViewer.Plugin.Widgets.FacebookPixel
{
    /// <summary>
    ...
    public class FacebookPixelPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override async Task InstallAsync()
        {
            await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                ["Plugins.Widgets.FacebookPixel.Configuration.Fields.TrackAddToCart.Hint"] = "Check to enable tracking standard event, when a tvChannel is added to the shopping cart.",
                ["Plugins.Widgets.FacebookPixel.Configuration.Fields.TrackAddToWishlist"] = "Track \"AddToWishlist\" event",
                ["Plugins.Widgets.FacebookPixel.Configuration.Fields.TrackAddToWishlist.Hint"] = "Check to enable tracking standard event, when a tvChannel is added to the wishlist.",
                ...
                ["Plugins.Widgets.FacebookPixel.Configuration.Fields.TrackViewContent.Hint"] = "Check to enable tracking standard event, when a person lands on a tvChannel details page.",
