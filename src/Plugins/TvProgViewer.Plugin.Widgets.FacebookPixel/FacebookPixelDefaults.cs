...
namespace TvProgViewer.Plugin.Widgets.FacebookPixel
{
    ...
    public class FacebookPixelDefaults
    {
        ...
        /// </remarks>
        public static CacheKey ConfigurationCacheKey => new("TvProg.Plugin.Widgets.FacebookPixel.Configuration-{0}", PrefixCacheKey);
        ...
        /// {0} : store identifier
        /// </remarks>
        public static CacheKey ConfigurationsCacheKey => new("TvProg.Plugin.Widgets.FacebookPixel.Configurations-{0}", PrefixCacheKey);

        /// <summary>
        /// Gets the cache key for custom events
        /// </summary>
        public static CacheKey CustomEventsCacheKey => new("TvProg.Plugin.Widgets.FacebookPixel.CustomEvents-{0}", PrefixCacheKey);

        /// <summary>
        /// Gets the cache key for widget zones
        /// </summary>
        public static CacheKey WidgetZonesCacheKey => new("TvProg.Plugin.Widgets.FacebookPixel.WidgetZones", PrefixCacheKey);

        /// <summary>
        /// Gets the prefix key to clear cache
        /// </summary>
        public static string PrefixCacheKey => "TvProg.Plugin.Widgets.FacebookPixel";
