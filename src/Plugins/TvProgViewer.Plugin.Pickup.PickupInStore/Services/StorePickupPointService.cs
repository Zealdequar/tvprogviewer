...
namespace TvProgViewer.Plugin.Pickup.PickupInStore.Services
{
    /// <summary>
    ...
    public class StorePickupPointService : IStorePickupPointService
    {
        ...
        /// {0} : current store ID
        /// </remarks>
        private readonly CacheKey _pickupPointAllKey = new("TvProg.pickuppoint.all-{0}", PICKUP_POINT_PATTERN_KEY);
        private const string PICKUP_POINT_PATTERN_KEY = "TvProg.pickuppoint.";
