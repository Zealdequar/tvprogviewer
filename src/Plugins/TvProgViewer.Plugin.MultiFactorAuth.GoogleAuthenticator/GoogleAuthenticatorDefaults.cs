...
namespace TvProgViewer.Plugin.MultiFactorAuth.GoogleAuthenticator
{
    ...
    public class GoogleAuthenticatorDefaults
    {
        ...
        /// </remarks>
        public static CacheKey ConfigurationCacheKey => new("TvProg.PluginMultiFactorAuth.GoogleAuthenticator.Configuration-{0}", PrefixCacheKey);

        /// <summary>
        /// Gets the prefix key to clear cache
        /// </summary>
        public static string PrefixCacheKey => "TvProg.Plugin.MultiFactorAuth.GoogleAuthenticator";
