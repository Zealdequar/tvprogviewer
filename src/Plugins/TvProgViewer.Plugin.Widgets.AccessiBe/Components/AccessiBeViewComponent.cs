...
using TvProgViewer.Plugin.Widgets.AccessiBe.Services;
using TvProgViewer.Web.Framework.Components;

namespace TvProgViewer.Plugin.Widgets.AccessiBe.Components
{
    /// <summary>
    /// Represents the view component to place a widget into pages
    /// </summary>
    public class AccessiBeViewComponent : TvProgViewComponent
    {
        #region Fields
