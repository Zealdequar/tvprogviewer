...
namespace TvProgViewer.Plugin.Payments.CyberSource
{
    ...
    public class CyberSourceDefaults
    {
        ...
        /// <summary>
        /// Gets the user action token type name
        /// </summary>
        public static string UserActionTokenTypeName => "user";
        ...
        /// </summary>
        public static string UserTokensRouteName => "Plugin.Payments.CyberSource.UserTokens";

        /// <summary>
        /// Gets the CyberSource payment token add route name
        /// </summary>
        public static string UserTokenAddRouteName => "Plugin.Payments.CyberSource.UserTokenAdd";

        /// <summary>
        /// Gets the CyberSource payment token edit route name
        /// </summary>
        public static string UserTokenEditRouteName => "Plugin.Payments.CyberSource.UserTokenEdit";

        /// <summary>
        /// Gets the class name of the CyberSource payment token menu item
        /// </summary>
        public static string UserTokensMenuClassName => "cybersource-tokens";

        /// <summary>
        /// Gets the tab id of the CyberSource payment token menu item
        /// </summary>
        public static int UserTokensMenuTab => 500;
        ...
        /// </summary>
        public static string OrderStatusUpdateTask => "TvProg.Plugin.Payments.CyberSource.Services.OrderStatusUpdateTask";
