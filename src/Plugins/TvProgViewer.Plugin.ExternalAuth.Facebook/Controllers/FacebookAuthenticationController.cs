...
using TvProgViewer.Plugin.ExternalAuth.Facebook.Models;
...
namespace TvProgViewer.Plugin.ExternalAuth.Facebook.Controllers
{
    ...
    public class FacebookAuthenticationController : BasePluginController
    {
        ...
        public async Task<IActionResult> Login(string returnUrl)
        {
            ...
            var methodIsAvailable = await _authenticationPluginManager
                .IsPluginActiveAsync(FacebookAuthenticationDefaults.SystemName, await _workContext.GetCurrentUserAsync(), store.Id);
            if (!methodIsAvailable)
                throw new TvProgException("Facebook authentication module cannot be loaded");
            ...
            {
                throw new TvProgException("Facebook authentication module not configured");
            }
