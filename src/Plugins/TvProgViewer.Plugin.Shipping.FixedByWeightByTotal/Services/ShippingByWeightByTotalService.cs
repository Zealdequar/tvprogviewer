...
namespace TvProgViewer.Plugin.Shipping.FixedByWeightByTotal.Services
{
    /// <summary>
    ...
    public class ShippingByWeightByTotalService : IShippingByWeightByTotalService
    {
        ...
        /// </summary>
        private readonly CacheKey _shippingByWeightByTotalAllKey = new("TvProg.shippingbyweightbytotal.all", SHIPPINGBYWEIGHTBYTOTAL_PATTERN_KEY);
        private const string SHIPPINGBYWEIGHTBYTOTAL_PATTERN_KEY = "TvProg.shippingbyweightbytotal.";
