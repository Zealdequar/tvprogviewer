...
namespace TvProgViewer.Plugin.Tax.Avalara.Infrastructure
{
    /// <summary>
    ...
    public class RouteProvider : BaseRouteProvider, IRouteProvider
    {
        ...
        public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            endpointRouteBuilder.MapControllerRoute(name: AvalaraTaxDefaults.ExemptionCertificatesRouteName,
                pattern: $"{lang}/user/exemption-certificates",
        ...
        /// </summary>
        public int Priority => 1; //set a value that is greater than the default one in TvProg.Web to override routes
    }
}