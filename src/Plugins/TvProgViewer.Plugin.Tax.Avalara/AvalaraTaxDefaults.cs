...
namespace TvProgViewer.Plugin.Tax.Avalara
{
    ...
    public class AvalaraTaxDefaults
    {
        ...
        /// </summary>
        public static string ApplicationName => "tvProgViewer-AvalaraTaxRateProvider|a0o33000004BoPM";

        /// <summary>
        /// Gets the Avalara tax provider version (used a tvProgViewer version here)
        /// </summary>
        public static string ApplicationVersion => $"v{TvProgVersion.CURRENT_VERSION}";
        ...
        /// <summary>
        /// Gets the name of the generic attribute that is used to store an entity use code (user usage type)
        /// </summary>
        ...
        /// {0} - Zip postal code
        /// </remarks>
        public static CacheKey TaxRateByZipCacheKey => new("TvProg.avalara.taxratebyzip.{0}");
        ...
        /// {6} - Zip postal code
        /// </remarks>
        public static CacheKey TaxRateCacheKey => new("TvProg.avalara.taxrate.{0}-{1}-{2}-{3}-{4}-{5}-{6}", TaxRateCacheKeyByUserPrefix);
        ...
        /// {0} : User id
        /// </remarks>
        public static string TaxRateCacheKeyByUserPrefix => "TvProg.avalara.taxrate.{0}-";

        /// <summary>
        /// Gets the key for caching Avalara tax code types
        /// </summary>
        public static CacheKey TaxCodeTypesCacheKey => new("TvProg.avalara.taxcodetypes");

        /// <summary>
        /// Gets the key for caching Avalara system entity use codes
        /// </summary>
        public static CacheKey EntityUseCodesCacheKey => new("TvProg.avalara.entityusecodes");
        ...
        public static (string Name, string Type, int Days) DownloadTaxRatesTask =>
            ($"Download tax rates ({SystemName})", "TvProg.Plugin.Tax.Avalara.Services.DownloadTaxRatesTask", 7);
