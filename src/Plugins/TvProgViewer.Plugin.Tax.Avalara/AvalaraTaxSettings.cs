...
namespace TvProgViewer.Plugin.Tax.Avalara
{
    ...
    public class AvalaraTaxSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to validate entered by user addresses before the tax calculation
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to allow users to edit their info 
        /// </summary>
        public bool AllowEditUser { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to display a message that there are no valid certificates for the user on the order confirmation page
        /// </summary>
        public bool DisplayNoValidCertificatesMessage { get; set; }

        /// <summary>
        /// Gets or sets the identifiers of user roles for which certificates are available
        /// </summary>
        public List<int> UserRoleIds { get; set; } = new();

        /// <summary>
        /// Gets or sets a value indicating whether to disaply a preview of user's new certificate before signing and submitting
        /// </summary>
        public bool PreviewCertificate { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether the user must upload a scanned copy of their exemption certificate
        /// </summary>
        public bool UploadOnly { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to disable the upload of prefilled documents, so that users must generate a new copy of the certificate by entering their information
        /// </summary>
