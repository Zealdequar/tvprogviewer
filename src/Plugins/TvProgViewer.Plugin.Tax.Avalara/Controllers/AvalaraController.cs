    ...
    public class AvalaraController : BasePluginController
    {
        ...
        public async Task<IActionResult> Configure(string testTaxResult = null)
        {
            ...
            var model = new ConfigurationModel
            {
                ...
                AllowEditUser = _avalaraTaxSettings.AllowEditUser,
                DisplayNoValidCertificatesMessage = _avalaraTaxSettings.DisplayNoValidCertificatesMessage,
                SelectedUserRoleIds = _avalaraTaxSettings.UserRoleIds,
            ...
            model.HideGeneralBlock = await _genericAttributeService.GetAttributeAsync<bool>(user, AvalaraTaxDefaults.HideGeneralBlock);
            model.HideLogBlock = await _genericAttributeService.GetAttributeAsync<bool>(user, AvalaraTaxDefaults.HideLogBlock);
        ...
        public async Task<IActionResult> Configure(ConfigurationModel model)
        {
            ...
            _avalaraTaxSettings.AllowEditUser = model.AllowEditUser;
            _avalaraTaxSettings.DisplayNoValidCertificatesMessage = model.DisplayNoValidCertificatesMessage;
            _avalaraTaxSettings.UserRoleIds = model.SelectedUserRoleIds.ToList();
            await _settingService.SaveSettingAsync(_avalaraTaxSettings);
        ...
        public async Task<IActionResult> ChangeEnableCertificates(bool enabled)
        {
            ...
            if (enabled)
            {
                ...
                message = string.Format(locale, Url.Action("UserUser", "Setting"));
            }
