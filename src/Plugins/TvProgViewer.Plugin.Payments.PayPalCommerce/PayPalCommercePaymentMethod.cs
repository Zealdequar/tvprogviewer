...
using TvProgViewer.Plugin.Payments.PayPalViewer.Components;
...
namespace TvProgViewer.Plugin.Payments.PayPalViewer
{
    /// <summary>
    /// Represents a payment method implementation
    /// </summary>
    public class PayPalViewerPaymentMethod : BasePlugin, IPaymentMethod, IWidgetPlugin
    {
        #region Fields
        ...
        public PayPalViewerPaymentMethod(CurrencySettings currencySettings,
        ...
        public async Task<ProcessPaymentResult> ProcessPaymentAsync(ProcessPaymentRequest processPaymentRequest)
        {
            ...
            var orderIdKey = await _localizationService.GetResourceAsync("Plugins.Payments.PayPalViewer.OrderId");
            if (!processPaymentRequest.CustomValues.TryGetValue(orderIdKey, out var orderId) || string.IsNullOrEmpty(orderId?.ToString()))
                throw new TvProgException("Failed to get the PayPal order ID");
        ...
        public async Task<RefundPaymentResult> RefundAsync(RefundPaymentRequest refundPaymentRequest)
        {
            ...
            var currency = await _currencyService.GetCurrencyByIdAsync(_currencySettings.PrimaryStoreCurrencyId)
                ?? throw new TvProgException("Primary store currency cannot be loaded");
            ...
            var refundIds = await _genericAttributeService
                .GetAttributeAsync<List<string>>(refundPaymentRequest.Order, PayPalViewerDefaults.RefundIdAttributeName)
                ?? new List<string>();
            if (!refundIds.Contains(refund.Id))
                refundIds.Add(refund.Id);
            await _genericAttributeService.SaveAttributeAsync(refundPaymentRequest.Order, PayPalViewerDefaults.RefundIdAttributeName, refundIds);
        ...
        public Task<ProcessPaymentRequest> GetPaymentInfoAsync(IFormCollection form)
        {
            ...
            return Task.FromResult(_actionContextAccessor.ActionContext.HttpContext.Session
                .Get<ProcessPaymentRequest>(PayPalViewerDefaults.PaymentRequestSessionKey));
        }
        ...
        {
            return _urlHelperFactory.GetUrlHelper(_actionContextAccessor.ActionContext).RouteUrl(PayPalViewerDefaults.ConfigurationRouteName);
        }
        ...
        {
            //settings
            await _settingService.SaveSettingAsync(new PayPalViewerSettings
            {
            ...
            if (!_paymentSettings.ActivePaymentMethodSystemNames.Contains(PayPalViewerDefaults.SystemName))
            {
                _paymentSettings.ActivePaymentMethodSystemNames.Add(PayPalViewerDefaults.SystemName);
                await _settingService.SaveSettingAsync(_paymentSettings);
            }

            if (!_widgetSettings.ActiveWidgetSystemNames.Contains(PayPalViewerDefaults.SystemName))
            {
                _widgetSettings.ActiveWidgetSystemNames.Add(PayPalViewerDefaults.SystemName);
            ...
            {
                ["Enums.TvProg.Plugin.Payments.PayPalViewer.Domain.PaymentType.Authorize"] = "Authorize",
                ["Enums.TvProg.Plugin.Payments.PayPalViewer.Domain.PaymentType.Capture"] = "Capture",
                ["Plugins.Payments.PayPalViewer.Configuration.Error"] = "Error: {0} (see details in the <a href=\"{1}\" target=\"_blank\">log</a>)",
                ["Plugins.Payments.PayPalViewer.Credentials.Valid"] = "The specified credentials are valid",
                ["Plugins.Payments.PayPalViewer.Credentials.Invalid"] = "The specified credentials are invalid",
                ...
                ["Plugins.Payments.PayPalViewer.Fields.DisplayLogoInFooter.Hint"] = "Determine whether to display PayPal logo in the footer. These logos and banners are a great way to let your buyers know that you choose PayPal to securely process their payments.",
                ["Plugins.Payments.PayPalViewer.Fields.DisplayLogoInHeaderLinks"] = "Display logo in header links",
                ["Plugins.Payments.PayPalViewer.Fields.DisplayLogoInHeaderLinks.Hint"] = "Determine whether to display PayPal logo in header links. These logos and banners are a great way to let your buyers know that you choose PayPal to securely process their payments.",
                ...
                ["Plugins.Payments.PayPalViewer.Fields.Email"] = "Email",
                ["Plugins.Payments.PayPalViewer.Fields.Email.Hint"] = "Enter your email to get access to PayPal payments.",
                ["Plugins.Payments.PayPalViewer.Fields.LogoInFooter"] = "Logo source code",
                ["Plugins.Payments.PayPalViewer.Fields.LogoInFooter.Hint"] = "Enter source code of the logo. Find more logos and banners on PayPal Logo Center. You can also modify the code to fit correctly into your theme and site style.",
                ["Plugins.Payments.PayPalViewer.Fields.LogoInHeaderLinks"] = "Logo source code",
                ["Plugins.Payments.PayPalViewer.Fields.LogoInHeaderLinks.Hint"] = "Enter source code of the logo. Find more logos and banners on PayPal Logo Center. You can also modify the code to fit correctly into your theme and site style.",
                ["Plugins.Payments.PayPalViewer.Fields.PaymentType"] = "Payment type",
                ["Plugins.Payments.PayPalViewer.Fields.PaymentType.Hint"] = "Choose a payment type to either capture payment immediately or authorize a payment for an order after order creation. Notice, that alternative payment methods don't work with the 'authorize and capture later' feature.",
                ["Plugins.Payments.PayPalViewer.Fields.SecretKey"] = "Secret",
                ["Plugins.Payments.PayPalViewer.Fields.SecretKey.Hint"] = "Enter your PayPal REST API secret.",
                ["Plugins.Payments.PayPalViewer.Fields.SecretKey.Required"] = "Secret is required",
                ["Plugins.Payments.PayPalViewer.Fields.SetCredentialsManually"] = "Specify API credentials manually",
                ["Plugins.Payments.PayPalViewer.Fields.SetCredentialsManually.Hint"] = "Determine whether to manually set the credentials (for example, there is already an app created, or if you want to use the sandbox mode).",
                ["Plugins.Payments.PayPalViewer.Fields.UseSandbox"] = "Use sandbox",
                ["Plugins.Payments.PayPalViewer.Fields.UseSandbox.Hint"] = "Determine whether to use the sandbox environment for testing purposes.",
                ["Plugins.Payments.PayPalViewer.Onboarding.AccessRevoked"] = "Profile access has been successfully revoked.",
                ["Plugins.Payments.PayPalViewer.Onboarding.Button"] = "Sign up for PayPal",
                ["Plugins.Payments.PayPalViewer.Onboarding.ButtonRevoke"] = "Revoke access",
                ["Plugins.Payments.PayPalViewer.Onboarding.Completed"] = "Onboarding is sucessfully completed",
                ["Plugins.Payments.PayPalViewer.Onboarding.EmailSet"] = "Email is set, now you are ready to sign up for PayPal",
                ["Plugins.Payments.PayPalViewer.Onboarding.Error"] = "An error occurred during the onboarding process, the credentials are empty",
                ["Plugins.Payments.PayPalViewer.Onboarding.InProcess"] = "Onboarding is in process, see details below",
                ["Plugins.Payments.PayPalViewer.Onboarding.Process.Account"] = "PayPal account is created",
                ["Plugins.Payments.PayPalViewer.Onboarding.Process.Email"] = "Email address is confirmed",
                ["Plugins.Payments.PayPalViewer.Onboarding.Process.Payments"] = "Billing information is set",
                ["Plugins.Payments.PayPalViewer.Onboarding.Process.Permission"] = "Permissions are granted",
                ["Plugins.Payments.PayPalViewer.Onboarding.Title"] = "Sign up for PayPal",
                ["Plugins.Payments.PayPalViewer.OrderId"] = "PayPal order ID",
                ["Plugins.Payments.PayPalViewer.Prominently"] = "Feature PayPal Prominently",
                ["Plugins.Payments.PayPalViewer.PaymentMethodDescription"] = "PayPal Checkout with using methods like Venmo, PayPal Credit, credit card payments",
                ["Plugins.Payments.PayPalViewer.RoundingWarning"] = "It looks like you have <a href=\"{0}\" target=\"_blank\">RoundPricesDuringCalculation</a> setting disabled. Keep in mind that this can lead to a discrepancy of the order total amount, as PayPal rounds to two decimals only.",
                ["Plugins.Payments.PayPalViewer.WebhookWarning"] = "Webhook was not created, so some functions may not work correctly (see details in the <a href=\"{0}\" target=\"_blank\">log</a>. Please ensure that your store is under SSL, PayPal service doesn't send requests to unsecured sites.)"
            });
        ...
        public override async Task UninstallAsync()
        {
            ...
            if (_paymentSettings.ActivePaymentMethodSystemNames.Contains(PayPalViewerDefaults.SystemName))
            {
                _paymentSettings.ActivePaymentMethodSystemNames.Remove(PayPalViewerDefaults.SystemName);
                await _settingService.SaveSettingAsync(_paymentSettings);
            }

            if (_widgetSettings.ActiveWidgetSystemNames.Contains(PayPalViewerDefaults.SystemName))
            {
                _widgetSettings.ActiveWidgetSystemNames.Remove(PayPalViewerDefaults.SystemName);
                await _settingService.SaveSettingAsync(_widgetSettings);
            }

            await _settingService.DeleteSettingAsync<PayPalViewerSettings>();

            //locales
            await _localizationService.DeleteLocaleResourcesAsync("Enums.TvProg.Plugin.Payments.PayPalViewer");
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.Payments.PayPalViewer");
        ...
        public override async Task UpdateAsync(string currentVersion, string targetVersion)
        {
            ...
            if (current < 1.09M)
            {
                var settings = await _settingService.LoadSettingAsync<PayPalViewerSettings>();
        ...
        {
            return await _localizationService.GetResourceAsync("Plugins.Payments.PayPalViewer.PaymentMethodDescription");
        }
