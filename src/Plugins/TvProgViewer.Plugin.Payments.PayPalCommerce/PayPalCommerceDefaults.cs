...
namespace TvProgViewer.Plugin.Payments.PayPalViewer
{
    ...
    /// </summary>
    public class PayPalViewerDefaults
    {
        /// <summary>
        /// Gets the plugin system name
        /// </summary>
        public static string SystemName => "Payments.PayPalViewer";
        ...
        /// <summary>
        /// Gets the tvProgViewer partner code
        /// </summary>
        public static string PartnerCode => "TvProgViewer_PPCP";

        /// <summary>
        /// Gets the configuration route name
        /// </summary>
        public static string ConfigurationRouteName => "Plugin.Payments.PayPalViewer.Configure";

        /// <summary>
        /// Gets the webhook route name
        /// </summary>
        public static string WebhookRouteName => "Plugin.Payments.PayPalViewer.Webhook";
        ...
        /// </summary>
        public static string RefundIdAttributeName => "PayPalViewerRefundId";
