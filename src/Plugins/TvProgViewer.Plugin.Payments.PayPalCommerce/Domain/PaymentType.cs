namespace TvProgViewer.Plugin.Payments.PayPalViewer.Domain
{
    /// <summary>
    ...
    {
        /// <summary>
        /// The merchant intends to capture payment immediately after the user makes a payment.
        /// </summary>
        Capture,

        /// <summary>
        /// The merchant intends to authorize a payment and place funds on hold after the user makes a payment. 
