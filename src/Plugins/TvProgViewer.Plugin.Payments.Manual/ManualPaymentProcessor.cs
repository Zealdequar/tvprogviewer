...
using TvProgViewer.Plugin.Payments.Manual.Components;
using TvProgViewer.Plugin.Payments.Manual.Models;
using TvProgViewer.Plugin.Payments.Manual.Validators;
...
namespace TvProgViewer.Plugin.Payments.Manual
{
    /// <summary>
    ...
    public class ManualPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                ["Plugins.Payments.Manual.Fields.AdditionalFee.Hint"] = "Enter additional fee to charge your users.",
