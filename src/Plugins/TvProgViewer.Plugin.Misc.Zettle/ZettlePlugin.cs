    ...
    public class ZettlePlugin : BasePlugin, IAdminMenuPlugin, IMiscPlugin
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                ["Plugins.Misc.Zettle.Account.Pending"] = "Before your account is activated, you will go through a process to verify your identity. This process may take some time. See details <a href=\"{1}\" target=\"_blank\">here</a>. The current user status is {0}.",
