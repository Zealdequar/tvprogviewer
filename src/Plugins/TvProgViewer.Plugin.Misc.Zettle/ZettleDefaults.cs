...
namespace TvProgViewer.Plugin.Misc.Zettle
{
    ...
    public class ZettleDefaults
    {
        ...
        /// </summary>
        public static string ApplicationName => "tvProgViewer-integration";

        /// <summary>
        /// Gets the partner identifier
        /// </summary>
        public static string PartnerIdentifier => "tvProgViewer";
        ...
        public static (string Name, string Type, int Period) SynchronizationTask =>
            ("Synchronization (PayPal Zettle plugin)", "TvProg.Plugin.Misc.Zettle.Services.ZettleSyncTask", 28800);
    }
}