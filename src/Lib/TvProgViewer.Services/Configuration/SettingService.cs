...
namespace TvProgViewer.Services.Configuration
{
    ...
    public partial class SettingService : ISettingService
    {
        ...
        {
            return await _staticCacheManager.GetAsync(TvProgSettingsDefaults.SettingsAllAsDictionaryCacheKey, async () =>
            {
        ...
        {
            return _staticCacheManager.Get(TvProgSettingsDefaults.SettingsAllAsDictionaryCacheKey, () =>
            {
        ...
        {
            await _staticCacheManager.RemoveByPrefixAsync(TvProgEntityCacheDefaults<Setting>.Prefix);
        }
        ...
        {
            _staticCacheManager.RemoveByPrefix(TvProgEntityCacheDefaults<Setting>.Prefix);
        }
