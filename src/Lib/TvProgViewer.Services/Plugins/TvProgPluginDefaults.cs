...
namespace TvProgViewer.Services.Plugins
{
    ...
    /// </summary>
    public static partial class TvProgPluginDefaults
    {
        /// <summary>
        ...
        /// {0} : user identifier
        /// </remarks>
        public static CacheKey AdminNavigationPluginsCacheKey => new("TvProg.plugins.adminnavigation.{0}", AdminNavigationPluginsPrefix);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string AdminNavigationPluginsPrefix => "TvProg.plugins.adminnavigation.";
    }
}