...
namespace TvProgViewer.Services.Common
{
    ...
    /// </summary>
    public static partial class TvProgCommonDefaults
    {
        /// <summary>
        ...
        #region tvProgViewer official site

        /// <summary>
        /// Gets a path to request the tvProgViewer official site for license compliance check
        /// </summary>
        /// <remarks>
        /// {0} : store URL
        /// {1} : tvProgViewer version
        /// {2} : admin email
        /// {3} : language code
        /// </remarks>
        public static string TvProgLicenseCheckPath => "license-check?url={0}&version={1}&email={2}&language={3}";

        /// <summary>
        /// Gets a path to request the tvProgViewer official site for news RSS
        /// </summary>
        /// <remarks>
        /// {0} : tvProgViewer version
        /// {1} : whether the store based is on the localhost
        /// {2} : whether advertisements are hidden
        /// {3} : store URL
        /// {4} : language code
        /// </remarks>
        public static string TvProgNewsRssPath => "tvprogviewer-news-rss?version={0}&localhost={1}&hideAdvertisements={2}&storeUrl={3}&language={4}";

        /// <summary>
        /// Gets a path to request the tvProgViewer official site to notify about successful installation
        /// </summary>
        /// <remarks>
        /// {0} : tvProgViewer version
        /// {1} : whether the store based is on the localhost
        ...
        /// {5} : culture name
        /// </remarks>
        public static string TvProgInstallationCompletedPath => "installation-completed?version={0}&local={1}&email={2}&url={3}&language={4}&culture={5}";

        /// <summary>
        /// Gets a path to request the tvProgViewer official site for available categories of marketplace extensions
        /// </summary>
        /// <remarks>
        /// {0} : language code
        /// </remarks>
        public static string TvProgExtensionsCategoriesPath => "extensions-feed?getCategories=1&language={0}";

        /// <summary>
        /// Gets a path to request the tvProgViewer official site for available versions of marketplace extensions
        /// </summary>
        /// <remarks>
        /// {0} : language code
        /// </remarks>
        public static string TvProgExtensionsVersionsPath => "extensions-feed?getVersions=1&language={0}";

        /// <summary>
        /// Gets a path to request the tvProgViewer official site for marketplace extensions
        /// </summary>
        /// <remarks>
        ...
        /// {6} : language code
        /// </remarks>
        public static string TvProgExtensionsPath => "extensions-feed?category={0}&version={1}&price={2}&searchTerm={3}&pageIndex={4}&pageSize={5}&language={6}";
        ...
        /// {0} : address attribute ID
        /// </remarks>
        public static CacheKey AddressAttributeValuesByAttributeCacheKey => new("TvProg.addressattributevalue.byattribute.{0}");
        ...
        /// {1} : key group
        /// </remarks>
        public static CacheKey GenericAttributeCacheKey => new("TvProg.genericattribute.{0}-{1}");
