...
{
    /// <summary>
    /// Represents the HTTP client to request tvProgViewer official site
    /// </summary>
    public partial class TvProgHttpClient
    {
        #region Fields
        ...
        public TvProgHttpClient(AdminAreaSettings adminAreaSettings,
        ...
        public virtual async Task<string> GetLicenseCheckDetailsAsync()
        {
            ...
            var url = string.Format(TvProgCommonDefaults.TvProgLicenseCheckPath,
                storeUrl,
                TvProgVersion.FULL_VERSION,
