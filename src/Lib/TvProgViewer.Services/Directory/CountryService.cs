...
namespace TvProgViewer.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        public virtual async Task<IList<Country>> GetAllCountriesAsync(int languageId = 0, bool showHidden = false)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(TvProgDirectoryDefaults.CountriesAllCacheKey, languageId,
                showHidden, store);
        ...
        public virtual async Task<Country> GetCountryByTwoLetterIsoCodeAsync(string twoLetterIsoCode)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(TvProgDirectoryDefaults.CountriesByTwoLetterCodeCacheKey, twoLetterIsoCode);
        ...
        public virtual async Task<Country> GetCountryByThreeLetterIsoCodeAsync(string threeLetterIsoCode)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(TvProgDirectoryDefaults.CountriesByThreeLetterCodeCacheKey, threeLetterIsoCode);
