...
namespace TvProgViewer.Services.Directory
{
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        public virtual async Task<StateProvince> GetStateProvinceByAbbreviationAsync(string abbreviation, int? countryId = null)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(TvProgDirectoryDefaults.StateProvincesByAbbreviationCacheKey
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(TvProgDirectoryDefaults.StateProvincesByCountryCacheKey, countryId, languageId, showHidden);
        ...
        public virtual async Task<IList<StateProvince>> GetStateProvincesAsync(bool showHidden = false)
        {
            ...
            var stateProvinces = await _staticCacheManager.GetAsync(_staticCacheManager.PrepareKeyForDefaultCache(TvProgDirectoryDefaults.StateProvincesAllCacheKey, showHidden), async () => await query.ToListAsync());
