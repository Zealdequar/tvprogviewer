...
namespace TvProgViewer.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task<IList<TierPrice>> GetTierPricesAsync(Product product, User user, Store store);
        ...
        /// The task result contains the ier price
        /// </returns>
        Task<TierPrice> GetPreferredTierPriceAsync(Product product, User user, Store store, int quantity);
