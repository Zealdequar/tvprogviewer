...
namespace TvProgViewer.Services.Catalog
{
    ...
    public partial class ProductTagService : IProductTagService
    {
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(TvProgCatalogDefaults.ProductTagsByProductCacheKey, productId);
        ...
        public virtual async Task<Dictionary<int, int>> GetProductCountAsync(int storeId, bool showHidden = false)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(TvProgCatalogDefaults.ProductTagCountCacheKey, storeId, userRoleIds, showHidden);
            ...
            return await _staticCacheManager.GetAsync(key, async () =>
            {
                ...
                if (!showHidden)
                {
                    ...
                    productsQuery = await _aclService.ApplyAcl(productsQuery, userRoleIds);
