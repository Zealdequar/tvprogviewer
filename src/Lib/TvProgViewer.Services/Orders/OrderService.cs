...
namespace TvProgViewer.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        public virtual async Task<IPagedList<Order>> SearchOrdersAsync(int storeId = 0,
            ...
            string billingSmartPhone = null, string billingEmail = null, string billingLastName = "",
            string orderNotes = null, int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false)
        {
            ...
            query = from o in query
                ...
                where
                    ...
                    (string.IsNullOrEmpty(billingSmartPhone) || (!string.IsNullOrEmpty(oba.PhoneNumber) && oba.PhoneNumber.Contains(billingSmartPhone))) &&
            ...
            int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
        {
            ...
            var query1 = from rp in _recurringPaymentRepository.Table
                         ...
                         join c in _userRepository.Table on o.UserId equals c.Id
                         where
                         !rp.Deleted &&
