...
namespace TvProgViewer.Data.Migrations
{
    ...
    /// </summary>
    public class TvProgConventionSet : IConventionSet
    {
        #region Ctor

        public TvProgConventionSet(ITvProgDataProvider dataProvider)
        {
