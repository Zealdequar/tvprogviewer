...
namespace TvProgViewer.Data.Migrations.Installation
{
    ...
    public class SchemaMigration : AutoReversingMigration
    {
        ...
        public override void Up()
        {
            ...
            Create.TableFor<TvChannelAttribute>();
            Create.TableFor<PredefinedTvChannelAttributeValue>();
            Create.TableFor<TvChannelTag>();
            Create.TableFor<TvChannel>();
            Create.TableFor<TvChannelTemplate>();
            Create.TableFor<BackInStockSubscription>();
            Create.TableFor<RelatedTvChannel>();
            Create.TableFor<ReviewType>();
            Create.TableFor<SpecificationAttributeGroup>();
            Create.TableFor<SpecificationAttribute>();
            Create.TableFor<TvChannelAttributeCombination>();
            Create.TableFor<TvChannelAttributeMapping>();
            Create.TableFor<TvChannelAttributeValue>();
            ...
            Create.TableFor<TvChannelCategory>();
            Create.TableFor<CrossSellTvChannel>();
            Create.TableFor<Manufacturer>();
            Create.TableFor<ManufacturerTemplate>();
            Create.TableFor<TvChannelManufacturer>();
            Create.TableFor<TvChannelTvChannelTagMapping>();
            Create.TableFor<TvChannelReview>();
            Create.TableFor<TvChannelReviewHelpfulness>();
            Create.TableFor<TvChannelReviewReviewTypeMapping>();
            Create.TableFor<SpecificationAttributeOption>();
            Create.TableFor<TvChannelSpecificationAttribute>();
            Create.TableFor<TierPrice>();
            Create.TableFor<Warehouse>();
            Create.TableFor<DeliveryDate>();
            Create.TableFor<TvChannelAvailabilityRange>();
            ...
            Create.TableFor<DiscountTvChannelMapping>();
