...
namespace TvProgViewer.Data.Extensions
{
    ...
    public static class FluentMigratorExtensions
    {
        ...
        private static Dictionary<Type, Action<ICreateTableColumnAsTypeSyntax>> TypeMapping { get; } = new Dictionary<Type, Action<ICreateTableColumnAsTypeSyntax>>
        {
            ...
            [typeof(DateTime)] = c => c.AsTvProgDateTime2(),
        ...
        /// </summary>
        public static ICreateTableColumnOptionOrWithColumnSyntax AsTvProgDateTime2(this ICreateTableColumnAsTypeSyntax syntax)
        {
