...
namespace TvProgViewer.Data.DataProviders
{
    ...
    /// </summary>
    public partial class MsSqlTvProgDataProvider : BaseDataProvider, ITvProgDataProvider
    {
        #region Utils
        ...
        /// </summary>
        protected override IDataProvider LinqToDbDataProvider => SqlServerTools.GetDataProvider(SqlServerVersion.v2019, SqlServerProvider.MicrosoftDataSqlClient);
