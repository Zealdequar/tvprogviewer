...
using TvProgViewer.Data.DataProviders.Interceptors;
...
namespace TvProgViewer.Data.DataProviders
{
    public abstract partial class BaseDataProvider : IMappingEntityAccessor
    {
        ...
        protected static ConcurrentDictionary<Type, TvProgEntityDescriptor> EntityDescriptors { get; } = new ConcurrentDictionary<Type, TvProgEntityDescriptor>();
        ...
        public virtual void InitializeDatabase()
        {
            ...
            var targetAssembly = typeof(TvProgDbStartup).Assembly;
        ...
        public virtual TvProgEntityDescriptor GetEntityDescriptor(Type entityType)
        {
            return EntityDescriptors.GetOrAdd(entityType, t =>
            {
                ...
                return new TvProgEntityDescriptor
                {
                    EntityName = tableName,
                    SchemaName = builder.Expression.SchemaName,
                    Fields = builder.Expression.Columns.Select(column => new TvProgEntityFieldDescriptor
                    {
                        Name = column.Name,
