...
namespace TvProgViewer.Data
{
    ...
    public partial class DataSettingsManager
    {
        ...
        /// <returns>Data settings</returns>
        public static DataConfig LoadSettings(ITvProgFileProvider fileProvider = null, bool reload = false)
        {
            ...
            var filePath_json = fileProvider.MapPath(TvProgDataSettingsDefaults.FilePath);
            var filePath_txt = fileProvider.MapPath(TvProgDataSettingsDefaults.ObsoleteFilePath);
        ...
        /// <param name="fileProvider">File provider</param>
        public static void SaveSettings(DataConfig dataSettings, ITvProgFileProvider fileProvider)
        {
            AppSettingsHelper.SaveAppSettings(new List<IConfig> { dataSettings }, fileProvider);
