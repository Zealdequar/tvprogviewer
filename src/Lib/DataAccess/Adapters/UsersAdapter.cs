...
namespace TvProgViewer.DataAccess.Adapters
{
    ...
    public class UsersAdapter: AdapterBase
    {
        ...
        /// <param name="mobSmartPhone">Моб. телефон</param>
        /// <param name="otherSmartPhone1">Доп. телефон 1</param>
        /// <param name="otherSmartPhone2">Доп. телефон 2</param>
        ...
        public int UserStart(
            ...
            bool? gender,
            string email,
            string mobSmartPhone,
            string otherSmartPhone1,
            string otherSmartPhone2,
            string address,
            string gmtZone
            )
        {
            ...
            List<SqlParameter> pars = new List<SqlParameter>()
            {
                ...
                new SqlParameter("@MobPhoneNumber", SqlDbType.NVarChar, 25) {Value = mobSmartPhone},
                new SqlParameter("@OtherPhoneNumber1", SqlDbType.NVarChar, 25) {Value = otherSmartPhone1},
                new SqlParameter("@OtherPhoneNumber2", SqlDbType.NVarChar, 25) {Value = otherSmartPhone2},
            ...
            string gmtZone)
        {
            ...
            try
            {
                ...
                if (su != null)
                {
                    ...
                    su.Gender = gender;
                    su.Email = email;
                    su.MobPhoneNumber = mobSmartPhone;
                    su.OtherPhoneNumber1 = otherSmartPhone1;
                    su.OtherPhoneNumber2 = otherSmartPhone2;
                    su.StreetAddress = streetAddress;
                    su.City = city;
                    su.GmtZone = gmtZone;
                    dataContext.SaveChanges();
                }
