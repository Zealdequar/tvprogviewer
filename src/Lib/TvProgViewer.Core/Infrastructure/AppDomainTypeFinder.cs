...
{
    /// <summary>
    /// A class that finds types needed by TvProg by looping assemblies in the 
    ...
    public partial class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected ITvProgFileProvider _fileProvider;

        #endregion

        #region Ctor

        public AppDomainTypeFinder(ITvProgFileProvider fileProvider = null)
        {
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into TvProg.
        /// </returns>
        ...
        /// <summary>Gets or sets whether TvProg should iterate assemblies in the app domain when loading TvProg types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that TvProg assemblies aren't investigated (e.g. by not including something like "^TvProg|..." you may break core functionality.</remarks>
