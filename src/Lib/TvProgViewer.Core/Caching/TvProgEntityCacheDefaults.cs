namespace TvProgViewer.Core.Caching
{
    ...
    public static partial class TvProgEntityCacheDefaults<TEntity> where TEntity : BaseEntity
    {
        ...
        /// {0} : entity id
        /// </remarks>
        public static CacheKey ByIdCacheKey => new($"TvProg.{EntityTypeName}.byid.{{0}}", ByIdPrefix, Prefix);
        ...
        /// {0} : entity ids
        /// </remarks>
        public static CacheKey ByIdsCacheKey => new($"TvProg.{EntityTypeName}.byids.{{0}}", ByIdsPrefix, Prefix);

        /// <summary>
        /// Gets a key for caching all entities
        /// </summary>
        public static CacheKey AllCacheKey => new($"TvProg.{EntityTypeName}.all.", AllPrefix, Prefix);
