...
namespace TvProgViewer.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IDiscountSupported<DiscountProductMapping>, ISoftDeletedEntity
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the product allows user reviews
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this product is returnable (a user is allowed to submit return request with this product)
        /// </summary>
