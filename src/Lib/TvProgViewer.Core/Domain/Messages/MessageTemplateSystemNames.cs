namespace TvProgViewer.Core.Domain.Messages
{
    ...
    public static partial class MessageTemplateSystemNames
    {
        ...
        /// </summary>
        public const string UserRegisteredStoreOwnerNotification = "NewUser.Notification";
        ...
        /// <summary>
        /// Represents system name of notification user about ready for pickup shipment
        /// </summary>
        public const string ShipmentReadyForPickupUserNotification = "ShipmentReadyForPickup.UserNotification";
        ...
        /// <summary>
        /// Represents system name of notification user about processing order
        /// </summary>
        public const string OrderProcessingUserNotification = "OrderProcessing.UserNotification";
