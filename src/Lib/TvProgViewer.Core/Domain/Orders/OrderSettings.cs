...
namespace TvProgViewer.Core.Domain.Orders
{
    ...
    public partial class OrderSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether PDF invoices should be generated in user language. Otherwise, use the current one
        /// </summary>
        public bool GeneratePdfInvoiceInUserLanguage { get; set; }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether users are allowed to upload files
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to display order amounts in user's currency on the order details page in the admin area
        /// </summary>
        public bool DisplayUserCurrencyOnOrders { get; set; }
