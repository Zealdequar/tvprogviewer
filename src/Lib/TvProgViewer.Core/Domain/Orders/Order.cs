...
namespace TvProgViewer.Core.Domain.Orders
{
    ...
    public partial class Order : BaseEntity, ISoftDeletedEntity
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether a user chose "pick up in store" shipping option
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the user currency code (at the moment of order placing)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the user tax display type identifier
        /// </summary>
        public int UserTaxDisplayTypeId { get; set; }
        ...
        /// <summary>
        /// Gets or sets the user language identifier
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the reward points history record (spent by a user when placing this order)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the user tax display type
        /// </summary>
        public TaxDisplayType UserTaxDisplayType
        {
            get => (TaxDisplayType)UserTaxDisplayTypeId;
            set => UserTaxDisplayTypeId = (int)value;
        }
