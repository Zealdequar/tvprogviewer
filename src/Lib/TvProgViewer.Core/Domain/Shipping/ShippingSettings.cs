...
namespace TvProgViewer.Core.Domain.Shipping
{
    ...
    public partial class ShippingSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether users can choose "Pick Up in Store" option during checkout (displayed on the "billing address" checkout step)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether users should be notified when shipping is made from multiple locations (warehouses)
        /// </summary>
