...
namespace TvProgViewer.Core.Domain.Tax
{
    /// <summary>
    /// Tax settings
    /// </summary>
    public partial class TaxSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether users are allowed to select tax display type
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether EU VAT (Europe Union Value Added Tax) for guest users is enabled
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this store will exempt eligible VAT-registered users from VAT
        /// </summary>
