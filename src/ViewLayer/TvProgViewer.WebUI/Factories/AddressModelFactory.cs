    ...
    public partial class AddressModelFactory : IAddressModelFactory
    {
            ...
            Address address, string overrideAttributesXml = "")
        {
            ...
            foreach (var attribute in attributes)
            {
                ...
                {
                    Id = attribute.Id,
                    ControlId = string.Format(TvProgCommonDefaults.AddressAttributeControlName, attribute.Id),
            ...
            string overrideAttributesXml = "")
        {
            ...
            if (address == null && prePopulateWithUserFields)
            {
                ...
                model.PhoneNumber = user.SmartPhone;
                model.FaxNumber = user.Fax;
            }
            ...
            model.SmartPhoneEnabled = addressSettings.SmartPhoneEnabled;
            model.SmartPhoneRequired = addressSettings.SmartPhoneRequired;
