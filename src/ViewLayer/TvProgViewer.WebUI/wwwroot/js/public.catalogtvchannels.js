var CatalogTvChannels = {
  ...
  getTvChannels: function (pageNumber) {
    if (this.params.jqXHR && this.params.jqXHR.readyState !== 4) {
      this.params.jqXHR.abort();
    }

    var urlBuilder = createTvChannelsURLBuilder(this.settings.browserPath);
...
function createTvChannelsURLBuilder(basePath) {
  return {
    params: {
      basePath: basePath,
      query: {}
