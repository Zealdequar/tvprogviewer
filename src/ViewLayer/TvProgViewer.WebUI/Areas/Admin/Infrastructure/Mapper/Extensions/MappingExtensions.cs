...
namespace TvProgViewer.WebUI.Areas.Admin.Infrastructure.Mapper.Extensions
{
    /// <summary>
    ...
    public static class MappingExtensions
    {
        ...
        public static TModel ToModel<TModel>(this BaseEntity entity) where TModel : BaseTvProgEntityModel
        {
            if (entity == null)
        ...
        public static TModel ToModel<TEntity, TModel>(this TEntity entity, TModel model)
            where TEntity : BaseEntity where TModel : BaseTvProgEntityModel
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public static TEntity ToEntity<TEntity>(this BaseTvProgEntityModel model) where TEntity : BaseEntity
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToSettingsModel<TModel>(this ISettings settings) where TModel : BaseTvProgModel, ISettingsModel
        {
            if (settings == null)
        ...
        public static TSettings ToSettings<TSettings, TModel>(this TModel model, TSettings settings)
            where TSettings : class, ISettings where TModel : BaseTvProgModel, ISettingsModel
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToConfigModel<TModel>(this IConfig config) where TModel : BaseTvProgModel, IConfigModel
        {
            if (config == null)
        ...
        public static TConfig ToConfig<TConfig, TModel>(this TModel model, TConfig config)
            where TConfig : class, IConfig where TModel : BaseTvProgModel, IConfigModel
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToPluginModel<TModel>(this IPlugin plugin) where TModel : BaseTvProgModel, IPluginModel
        {
            if (plugin == null)
        ...
        public static TModel ToPluginModel<TModel>(this PluginDescriptor pluginDescriptor, TModel model = null)
            where TModel : BaseTvProgModel, IPluginModel
        {
