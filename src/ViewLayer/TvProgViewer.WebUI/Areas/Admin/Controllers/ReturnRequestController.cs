...
namespace TvProgViewer.WebUI.Areas.Admin.Controllers
{
    public partial class ReturnRequestController : BaseAdminController
    {
        ...
        public virtual async Task<IActionResult> Edit(ReturnRequestModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    //activity log
                    await _userActivityService.InsertActivityAsync("EditReturnRequest",
        ...
        public virtual async Task<IActionResult> NotifyUser(ReturnRequestModel model)
        {
            if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageReturnRequests))
                return AccessDeniedView();
            ...
            var queuedEmailIds = await _workflowMessageService.SendReturnRequestStatusChangedUserNotificationAsync(returnRequest, orderItem, order);
        ...
        public virtual async Task<IActionResult> Delete(int id)
        {
            ...
            //activity log
            await _userActivityService.InsertActivityAsync("DeleteReturnRequest",
