...
{
    /// <summary>
    /// Represents a tvchannel search model to add to the manufacturer
    /// </summary>
    public partial record AddTvChannelToManufacturerSearchModel : BaseSearchModel
    {
        #region Ctor

        public AddTvChannelToManufacturerSearchModel()
        {
