...
{
    /// <summary>
    /// Represents a tvChannel search model to associate to the tvChannel attribute value
    /// </summary>
    public partial record AssociateTvChannelToAttributeValueSearchModel : BaseSearchModel
    {
        #region Ctor

        public AssociateTvChannelToAttributeValueSearchModel()
        {
            ...
            AssociateTvChannelToAttributeValueModel = new AssociateTvChannelToAttributeValueModel();
        }
        ...
        public AssociateTvChannelToAttributeValueModel AssociateTvChannelToAttributeValueModel { get; set; }
