...
{
    /// <summary>
    /// Represents a tvchannel search model to add to the category
    /// </summary>
    public partial record AddTvChannelToCategorySearchModel : BaseSearchModel
    {
        #region Ctor

        public AddTvChannelToCategorySearchModel()
        {
