...
namespace TvProgViewer.WebUI.Areas.Admin.Models.Settings
{
    ...
    public partial record CatalogSettingsModel : BaseTvProgModel, ISettingsModel
    {
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.AllowViewUnpublishedProductPage")]
        public bool AllowViewUnpublishedProductPage { get; set; }
        public bool AllowViewUnpublishedProductPage_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.DisplayDiscontinuedMessageForUnpublishedProducts")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ShowSkuOnProductDetailsPage")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.AllowProductSorting")]
        public bool AllowProductSorting { get; set; }
        public bool AllowProductSorting_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.AllowProductViewModeChanging")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ShowProductsFromSubcategories")]
        public bool ShowProductsFromSubcategories { get; set; }
        public bool ShowProductsFromSubcategories_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ShowCategoryProductNumber")]
        public bool ShowCategoryProductNumber { get; set; }
        public bool ShowCategoryProductNumber_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ShowCategoryProductNumberIncludingSubcategories")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductReviewsMustBeApproved")]
        public bool ProductReviewsMustBeApproved { get; set; }
        public bool ProductReviewsMustBeApproved_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.OneReviewPerProductFromUser")]
        public bool OneReviewPerProductFromUser { get; set; }
        public bool OneReviewPerProductFromUser_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.AllowAnonymousUsersToReviewProduct")]
        public bool AllowAnonymousUsersToReviewProduct { get; set; }
        public bool AllowAnonymousUsersToReviewProduct_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductReviewPossibleOnlyAfterPurchasing")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.NotifyStoreOwnerAboutNewProductReviews")]
        public bool NotifyStoreOwnerAboutNewProductReviews { get; set; }
        public bool NotifyStoreOwnerAboutNewProductReviews_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.NotifyUserAboutProductReviewReply")]
        public bool NotifyUserAboutProductReviewReply { get; set; }
        public bool NotifyUserAboutProductReviewReply_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ShowProductReviewsPerStore")]
        public bool ShowProductReviewsPerStore { get; set; }
        public bool ShowProductReviewsPerStore_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ShowProductReviewsTabOnAccountPage")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductReviewsPageSizeOnAccountPage")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductReviewsSortByCreatedDateAscending")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.RecentlyViewedProductsNumber")]
        public int RecentlyViewedProductsNumber { get; set; }
        public bool RecentlyViewedProductsNumber_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.RecentlyViewedProductsEnabled")]
        public bool RecentlyViewedProductsEnabled { get; set; }
        public bool RecentlyViewedProductsEnabled_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.NewProductsEnabled")]
        public bool NewProductsEnabled { get; set; }
        public bool NewProductsEnabled_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.NewProductsPageSize")]
        public int NewProductsPageSize { get; set; }
        public bool NewProductsPageSize_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.NewProductsAllowUsersToSelectPageSize")]
        public bool NewProductsAllowUsersToSelectPageSize { get; set; }
        public bool NewProductsAllowUsersToSelectPageSize_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.NewProductsPageSizeOptions")]
        public string NewProductsPageSizeOptions { get; set; }
        public bool NewProductsPageSizeOptions_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.CompareProductsEnabled")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.SearchPageProductsPerPage")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductSearchAutoCompleteEnabled")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductSearchEnabled")]
        public bool ProductSearchEnabled { get; set; }
        public bool ProductSearchEnabled_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductSearchAutoCompleteNumberOfProducts")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ShowProductImagesInSearchAutoComplete")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductSearchTermMinimumLength")]
        public int ProductSearchTermMinimumLength { get; set; }
        public bool ProductSearchTermMinimumLength_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductsAlsoPurchasedEnabled")]
        public bool ProductsAlsoPurchasedEnabled { get; set; }
        public bool ProductsAlsoPurchasedEnabled_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductsAlsoPurchasedNumber")]
        public int ProductsAlsoPurchasedNumber { get; set; }
        public bool ProductsAlsoPurchasedNumber_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.NumberOfProductTags")]
        public int NumberOfProductTags { get; set; }
        public bool NumberOfProductTags_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductsByTagPageSize")]
        public int ProductsByTagPageSize { get; set; }
        public bool ProductsByTagPageSize_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductsByTagAllowUsersToSelectPageSize")]
        public bool ProductsByTagAllowUsersToSelectPageSize { get; set; }
        public bool ProductsByTagAllowUsersToSelectPageSize_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductsByTagPageSizeOptions")]
        public string ProductsByTagPageSizeOptions { get; set; }
        public bool ProductsByTagPageSizeOptions_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductsByTagPriceRangeFiltering")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductsByTagPriceFrom")]
        public decimal ProductsByTagPriceFrom { get; set; }
        public bool ProductsByTagPriceFrom_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductsByTagPriceTo")]
        public decimal ProductsByTagPriceTo { get; set; }
        public bool ProductsByTagPriceTo_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductsByTagManuallyPriceRange")]
        public bool ProductsByTagManuallyPriceRange { get; set; }
        public bool ProductsByTagManuallyPriceRange_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.IncludeShortDescriptionInCompareProducts")]
        public bool IncludeShortDescriptionInCompareProducts { get; set; }
        public bool IncludeShortDescriptionInCompareProducts_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.IncludeFullDescriptionInCompareProducts")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.DisplayTaxShippingInfoProductDetailsPage")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.DisplayTaxShippingInfoProductBoxes")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ExportImportProductAttributes")]
        public bool ExportImportProductAttributes { get; set; }
        public bool ExportImportProductAttributes_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ExportImportProductSpecificationAttributes")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ExportImportProductCategoryBreadcrumb")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ExportImportSplitProductsFile")]
        public bool ExportImportSplitProductsFile { get; set; }
        public bool ExportImportSplitProductsFile_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.RemoveRequiredProducts")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ExportImportProductUseLimitedToStores")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.IgnoreFeaturedProducts")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.CacheProductPrices")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.UseAjaxCatalogProductsLoading")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductUrlStructureType")]
