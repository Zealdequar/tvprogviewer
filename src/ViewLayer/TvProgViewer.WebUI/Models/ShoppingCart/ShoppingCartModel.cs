...
namespace TvProgViewer.WebUI.Models.ShoppingCart
{
    public partial record ShoppingCartModel : BaseTvProgModel
    {
        ...
        public partial record CheckoutAttributeValueModel : BaseTvProgEntityModel
        {
            public string Name { get; set; }
        ...
        public partial record DiscountBoxModel: BaseTvProgModel
        {
            ...
            public partial record DiscountInfoModel : BaseTvProgEntityModel
            {
                public string CouponCode { get; set; }
            }
        }

        public partial record GiftCardBoxModel : BaseTvProgModel
        {
            public bool Display { get; set; }
        ...
        public partial record OrderReviewDataModel : BaseTvProgModel
        {
