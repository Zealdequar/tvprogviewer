...
{
    public partial record ProductDetailsModel : BaseTvProgEntityModel
    {
        ...
        public partial record ProductBreadcrumbModel : BaseTvProgModel
        {
        ...
        public partial record AddToCartModel : BaseTvProgModel
        {
            ...
            //qty
            [TvProgResourceDisplayName("Products.Qty")]
            public int EnteredQuantity { get; set; }
            public string MinimumQuantityNotification { get; set; }
            public List<SelectListItem> AllowedQuantities { get; set; }

            //price entered by users
            [TvProgResourceDisplayName("Products.EnterProductPrice")]
        ...
        public partial record GiftCardModel : BaseTvProgModel
        {
            ...
            [TvProgResourceDisplayName("Products.GiftCard.RecipientName")]
            public string RecipientName { get; set; }

            [TvProgResourceDisplayName("Products.GiftCard.RecipientEmail")]
            [DataType(DataType.EmailAddress)]
            public string RecipientEmail { get; set; }

            [TvProgResourceDisplayName("Products.GiftCard.SenderName")]
            public string SenderName { get; set; }

            [TvProgResourceDisplayName("Products.GiftCard.SenderEmail")]
            [DataType(DataType.EmailAddress)]
            public string SenderEmail { get; set; }

            [TvProgResourceDisplayName("Products.GiftCard.Message")]
