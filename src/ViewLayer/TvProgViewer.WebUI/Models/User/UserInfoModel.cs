...
{
    public partial record UserInfoModel : BaseTvProgModel
    {
        ...
        [DataType(DataType.EmailAddress)]
        [TvProgResourceDisplayName("Account.Fields.EmailToRevalidate")]
        ...
        [TvProgResourceDisplayName("Account.Fields.Signature")]
        ...
        [TvProgResourceDisplayName("Account.AssociatedExternalAuth")]
        ...
        public partial record AssociatedExternalAuthModel : BaseTvProgEntityModel
        {
            public string Email { get; set; }
