...
{
    public partial class AdvertiseRewardedBoxViewComponent : TvProgViewComponent
    {
        ...
        public AdvertiseRewardedBoxViewComponent(IGenericAttributeService genericAttributeService,
