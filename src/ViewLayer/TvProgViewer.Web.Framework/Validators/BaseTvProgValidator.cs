...
namespace TvProgViewer.Web.Framework.Validators
{
    ...
    public abstract partial class BaseTvProgValidator<TModel> : AbstractValidator<TModel> where TModel : class
    {
        #region Ctor
        ...
        protected virtual void SetStringPropertiesMaxLength(TvProgEntityDescriptor entityDescriptor, params string[] filterPropertyNames)
        {
        ...
        /// </summary>
        /// <param name="entityDescriptor">Entity descriptor</param>
        protected virtual void SetDecimalMaxValue(TvProgEntityDescriptor entityDescriptor)
        {
            if (entityDescriptor is null)
                return;
