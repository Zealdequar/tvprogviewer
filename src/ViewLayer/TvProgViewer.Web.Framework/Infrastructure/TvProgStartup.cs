...
namespace TvProgViewer.Web.Framework.Infrastructure
{
    ...
    public partial class TvProgStartup : ITvProgStartup
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<ICompareTvChannelsService, CompareTvChannelsService>();
            services.AddScoped<IRecentlyViewedTvChannelsService, RecentlyViewedTvChannelsService>();
            services.AddScoped<IManufacturerService, ManufacturerService>();
            services.AddScoped<IPriceFormatter, PriceFormatter>();
            services.AddScoped<ITvChannelAttributeFormatter, TvChannelAttributeFormatter>();
            services.AddScoped<ITvChannelAttributeParser, TvChannelAttributeParser>();
            services.AddScoped<ITvChannelAttributeService, TvChannelAttributeService>();
            services.AddScoped<ITvChannelService, TvChannelService>();
            services.AddScoped<ICopyTvChannelService, CopyTvChannelService>();
            services.AddScoped<ISpecificationAttributeService, SpecificationAttributeService>();
            services.AddScoped<ITvChannelTemplateService, TvChannelTemplateService>();
            ...
            services.AddScoped<ITvChannelTagService, TvChannelTagService>();
