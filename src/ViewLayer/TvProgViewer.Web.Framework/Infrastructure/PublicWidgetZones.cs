namespace TvProgViewer.Web.Framework.Infrastructure
{
    public static partial class PublicWidgetZones
    {
        ...
        public static string TvChannelBoxAddinfoAfter => "tvсhannelbox_addinfo_after";
        public static string TvChannelBoxAddinfoBefore => "tvсhannelbox_addinfo_before";
        public static string TvChannelBoxAddinfoMiddle => "tvсhannelbox_addinfo_middle";
        public static string TvChannelBreadcrumbAfter => "tvсhannelbreadcrumb_after";
        public static string TvChannelBreadcrumbBefore => "tvсhannelbreadcrumb_before";
        public static string TvChannelDetailsAddInfo => "tvсhanneldetails_add_info";
        public static string TvChannelDetailsAfterBreadcrumb => "tvсhanneldetails_after_breadcrumb";
        public static string TvChannelDetailsAfterPictures => "tvсhanneldetails_after_pictures";
        public static string TvChannelDetailsAfterDaysSelect => "tvсhanneldetails_after_days_select";
        public static string TvChannelDetailsAfterVideos => "tvсhanneldetails_after_videos";
        public static string TvChannelDetailsAfterProgrammeViewer => "tvсhanneldetails_after_programmeviewer";
        public static string TvChannelDetailsBeforeCollateral => "tvсhanneldetails_before_collateral";
        public static string TvChannelDetailsBeforePictures => "tvсhanneldetails_before_pictures";
        public static string TvChannelDetailsBeforeDaysSelect => "tvсhanneldetails_before_days_select";
        public static string TvChannelDetailsBeforeVideos => "tvсhanneldetails_before_videos";
        public static string TvChannelDetailsBeforeProgrammeViewer => "tvсhanneldetails_before_programmeviewer";
        public static string TvChannelDetailsBottom => "tvсhanneldetails_bottom";
        public static string TvChannelDetailsEssentialBottom => "tvсhanneldetails_essential_bottom";
        public static string TvChannelDetailsEssentialTop => "tvchanneldetails_essential_top";
        public static string TvChannelDetailsInsideOverviewButtonsAfter => "tvсhanneldetails_inside_overview_buttons_after";
        public static string TvChannelDetailsInsideOverviewButtonsBefore => "tvсhanneldetails_inside_overview_buttons_before";
        public static string TvChannelDetailsOverviewBottom => "tvсhanneldetails_overview_bottom";
        public static string TvChannelDetailsOverviewTop => "tvсhanneldetails_overview_top";
        public static string TvChannelDetailsTop => "tvсhanneldetails_top";
