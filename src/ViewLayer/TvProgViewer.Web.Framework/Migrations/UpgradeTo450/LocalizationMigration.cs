...
{
    [TvProgMigration("2021-04-23 00:00:00", "4.50.0", UpdateMigrationType.Localization, MigrationProcessType.Update)]
    public class LocalizationMigration : MigrationBase
    {
        ...
        public override void Up()
        {
            ...
            localizationService.AddOrUpdateLocaleResource(new Dictionary<string, string>
            {
                ...
                ["Enums.TvProg.Data.DataProviderType.Unknown"] = "Unknown",
                ["Enums.TvProg.Data.DataProviderType.SqlServer"] = "Microsoft SQL Server",
                ["Enums.TvProg.Data.DataProviderType.MySql"] = "MySQL",
                ["Enums.TvProg.Data.DataProviderType.PostgreSQL"] = "PostgreSQL",
                ...
                ["Admin.ContentManagement.MessageTemplates.Description.ShipmentReadyForPickup.UserNotification"] = "This message template is used to notify a user that the shipment of the certain order is ready for pickup.",
                ["Admin.ContentManagement.MessageTemplates.Description.ShipmentSent.UserNotification"] = "This message template is used to notify a user that the shipment of the certain order is sent.",
                ...
                ["Enums.TvProg.Core.Domain.Shipping.ShippingSortingEnum.Position"] = "Position",
                ["Enums.TvProg.Core.Domain.Shipping.ShippingSortingEnum.ShippingCost"] = "Shipping Cost",
                //#5138
                ...
                //#6052
                ["Account.Login.NewUserText"] = "By creating an account on our website, you will be able to shop faster, be up to date on an order's status, and keep track of the orders you have previously made.",
