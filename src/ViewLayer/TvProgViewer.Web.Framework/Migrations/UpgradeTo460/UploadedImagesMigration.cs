...
{
    [TvProgMigration("2022-10-18 00:00:00", "Move uploaded images to disk", MigrationProcessType.Update)]
    public class UploadedImagesMigration : Migration
    {
        ...
        public override void Up()
        {
            ...
            var pageIndex = 0;
            var uploadRoot = $"~{TvProgRoxyFilemanDefaults.DefaultRootDirectory}/";
