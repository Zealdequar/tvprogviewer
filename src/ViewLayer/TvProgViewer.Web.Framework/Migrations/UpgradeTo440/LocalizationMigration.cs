...
{
    [TvProgMigration("2020-06-10 00:00:00", "4.40.0", UpdateMigrationType.Localization, MigrationProcessType.Update)]
    public class LocalizationMigration : MigrationBase
    {
        ...
        public override void Up()
        {
            ...
            localizationService.DeleteLocaleResources(new List<string>
            {
                ...
                "Admin.Catalog.AdditionalTvChannelReviews.Fields.Description",
                ...
                "Admin.Catalog.TvChannels.TvChannelAttributes.Attributes.ValidationRules.ViewLink",
                "Admin.Catalog.TvChannels.TvChannelAttributes.Attributes.Values.EditAttributeDetails",
                "Admin.Catalog.TvChannels.SpecificationAttributes.NoAttributeOptions",
                "Admin.Catalog.TvChannels.SpecificationAttributes.SelectOption",
                ...
                "Admin.Configuration.Settings.UserUser.BlockTitle.DefaultFields",
                "Admin.Configuration.Settings.UserUser.BlockTitle.ExternalAuthentication",
                "Admin.Configuration.Settings.UserUser.BlockTitle.TimeZone",
                "Admin.Configuration.Settings.UserUser.UserSettings",
                "Admin.Configuration.Settings.Order.OrderSettings",
                "Admin.Configuration.Settings.TvChannelEditor.BlockTitle.LinkedTvChannels",
                "Admin.Configuration.Settings.TvChannelEditor.Id",
                ...
                "Admin.Users.Users.Fields.Email.Required",
                "Admin.Users.Users.Fields.FirstName.Required",
                "Admin.Users.Users.Fields.LastName.Required",
                "Admin.Users.Users.Fields.SystemName",
                "Admin.Users.Users.Fields.SystemName.Hint",
                "Admin.Users.Users.Fields.Username.Required",
                "Admin.Users.Users.RewardPoints.Alert.HistoryAdd",
                "Admin.DT.Processing",
                "Admin.TvProgViewerNews.HideAdv",
                "Admin.TvProgViewerNews.ShowAdv",
                ...
                "Enums.TvProg.Core.Domain.Common.FulltextSearchMode.And",
                "Enums.TvProg.Core.Domain.Common.FulltextSearchMode.ExactMatch",
                "Enums.TvProg.Core.Domain.Common.FulltextSearchMode.Or",
            ...
            localizationService.AddOrUpdateLocaleResource(new Dictionary<string, string>
            {
                ...
                ["Admin.Catalog.TvChannels.SpecificationAttributes.NameFormat"] = "{0} >> {1}",
                ...
                ["Admin.Users.Users.Fields.MultiFactorAuthenticationProvider"] = "Multi-factor authentication provider",
                ["Admin.Users.Users.Fields.MultiFactorAuthenticationProvider.Hint"] = "Name of the multi-factor authentication provider to which the user is associated.",
                ["Admin.Users.Users.UnbindMFAProvider"] = "The user has unbinded from the multifactor authentication provider successfully.",

                ["Admin.Configuration.Plugins.Description.DownloadMorePlugins"] = "You can download more tvProgViewer plugins in our <a href=\"{0}\" target=\"_blank\">marketplace</a>",
                ...
                ["TvChannels.EstimateShipping.NoSelectedShippingOption"] = "Please select the address you want to ship to",
                ["Admin.Configuration.Settings.UserUser.ForceMultifactorAuthentication"] = "Force multi-factor authentication",
                ["Admin.Configuration.Settings.UserUser.ForceMultifactorAuthentication.Hint"] = "Force activation of multi-factor authentication for all users (at least one MFA provider must be active).",
                ["Account.MultiFactorAuthentication.Warning.ForceActivation"] = "Enforce multi-factor authentication for all users is enabled.",
                ["Admin.Configuration.Settings.UserUser.ForceMultifactorAuthentication.Warning"] = "There are currently no active authentication providers. To use this setting, you must activate one of the multi-factor authentication providers.",
                ...
                //#5213
                ["Admin.System.Log.List.PremiumSupport"] = "Have questions or need help? Get dedicated support from the tvProgViewer team with a guaranteed response within 24 hours. Please find more about our premium support services <a href=\"{0}\" target=\"_blank\">here</a>.",
                ["Admin.System.Log.PremiumSupport"] = "Have questions or need help? Get dedicated support from the tvProgViewer team with a guaranteed response within 24 hours. Please find more about our premium support services <a href=\"{0}\" target=\"_blank\">here</a>.",
                ...
                ["Admin.ConfigurationSteps.AddStoreInfo.Description"] = "Enter your store details and protect your users using SSL",
                ["Admin.ConfigurationSteps.SetUpShipping.Title"] = "Set up shipping",
                ["Admin.ConfigurationSteps.SetUpShipping.Description"] = "Set up shipping methods to deliver orders to users",
                ...
                ["Admin.ConfigurationSteps.PoweredBy.Description"] = "Remove the “Powered by tvProgViewer” link from the footer",
                ...
                ["Admin.ConfigurationSteps.PaymentMethods.Manual.Text"] = "This is a special payment plugin that allows all orders to be successfully entered on the website, but it does NOT really charge a user or make any calls to any live payment gateway. This payment method is recommended if you want to perform one of the following: <ul><li>Process all orders offline</li><li>Process them manually via another back-office system</li><li>Test the site end-to-end before going live</li></ul>",
                ...
                ["Admin.ConfigurationSteps.Store.Name.Text"] = "Enter your store name in this field. It will be displayed, for instance, in the newsletter and notification emails sent to your users.",
                ...
                ["Admin.ConfigurationSteps.Topic.TitleContent.Text"] = "Enter a topic (page) title and its content in this field. This is what users will see in the public store.",
                ["Admin.ConfigurationSteps.Topic.Preview.Title"] = "Preview the page",
                ["Admin.ConfigurationSteps.Topic.Preview.Text"] = "To find out how your users will see the page, click the <b>Preview</b> button.",
                ...
                ["Admin.ConfigurationSteps.TopicList.Shipping.Text"] = "For example, this is a shipping info topic. It contains shipping information that users can access by clicking the appropriate link in your store.",
                ...
                ["Enums.TvProg.Services.Orders.GroupByOptions.Week"] = "Week",
                ["Enums.TvProg.Services.Orders.GroupByOptions.Month"] = "Month",
                ...
                ["Admin.Configuration.AppSettings.Common.SupportPreviousTvProgcommerceVersions"] = "Support previous tvProgViewer versions",
                ["Admin.Configuration.AppSettings.Common.SupportPreviousTvProgcommerceVersions.Hint"] = "Specify a value indicating whether we should support previous tvProgViewer versions (it can slightly improve performance). In this case, old URLs (from previous tvProgViewer versions) will redirect to new ones. Enable it only if you upgraded from one of the previous tvProgViewer versions.",
                ...
                ["Admin.Documentation.Reference.UserRoles"] = "Learn more about <a target=\"_blank\" href=\"{0}\">user roles</a>",
                ["Admin.Documentation.Reference.OnlineUsers"] = "Learn more about <a target=\"_blank\" href=\"{0}\">online users</a>",
                ...
                ["Admin.Documentation.Reference.Gdpr"] = "Learn more about <a target=\"_blank\" href=\"{0}\">GDPR in tvProgViewer</a>",
                ...
                ["Admin.Documentation.Reference.Plugins"] = "Learn more about <a target=\"_blank\" href=\"{0}\">plugins in tvProgViewer</a>",
                ...
                //#3950
                ["Admin.Catalog.TvChannels.TvChannelAttributes.Attributes.AlreadyExistsInCombination"] = "This attribute already exists in combination: '{0}'.",
                ...
                ["Plugins.Payments.PayPalStandard.Instructions"] = @"
                    <p>
	                    ...
	                    <br />7. For the <b>Return URL</b>, enter and save the URL on your site that will receive the transaction ID posted by PayPal after a user payment (<em>{0}</em>).
                ...
                //#3353
                ["Admin.Catalog.TvChannels.TvChannelAttributes.AttributeCombinations.Fields.MinStockQuantity"] = "Minimum stock qty",
                ["Admin.Catalog.TvChannels.TvChannelAttributes.AttributeCombinations.Fields.MinStockQuantity.Hint"] = "If you have enabled 'Manage stock by attributes' you can perform a number of different actions when the current stock quantity falls below (reaches) your minimum stock quantity (e.g. Low stock report).",
                ...
                ["Admin.Configuration.Settings.Catalog.TvChannelsByTagPriceRangeFiltering"] = "'TvChannels by tag' page. Price range filtering",
                ["Admin.Configuration.Settings.Catalog.TvChannelsByTagPriceRangeFiltering.Hint"] = "Check to enable the price range filtering on 'TvChannels by tag' page.",
                ...
                ["Admin.Configuration.Settings.Catalog.TvChannelsByTagPriceFrom"] = "'TvChannels by tag' page. Price 'from'",
                ["Admin.Configuration.Settings.Catalog.TvChannelsByTagPriceFrom.Hint"] = "Enter the price 'from' on 'TvChannels by tag' page.",
                ["Admin.Configuration.Settings.Catalog.TvChannelsByTagPriceFrom.GreaterThanOrEqualZero"] = "The price 'from' should be greater than or equal '0'.",
                ["Admin.Configuration.Settings.Catalog.TvChannelsByTagPriceTo"] = "'TvChannels by tag' page. Price 'to'",
                ["Admin.Configuration.Settings.Catalog.TvChannelsByTagPriceTo.Hint"] = "Enter the price 'to' on 'TvChannels by tag' page.",
                ["Admin.Configuration.Settings.Catalog.TvChannelsByTagPriceTo.GreaterThanZeroOrPriceFrom"] = "The price 'to' should be greater than '{0}'.",
                ...
                ["Enums.TvProg.Core.Domain.Catalog.AttributeValueOutOfStockDisplayType.AlwaysDisplay"] = "Always display",
                ...
                ["Admin.Configuration.Settings.Shipping.EstimateShippingCityNameEnabled.Hint"] = "Check to allow users to enter a city name instead of zip postal code.",
            ...
            this.RenameLocales(new Dictionary<string, string>
            {
                ...
                ["Admin.Catalog.Attributes.SpecificationAttributes.Options.Fields.NumberOfAssociatedTvChannels"] = "Admin.Catalog.Attributes.SpecificationAttributes.SpecificationAttribute.Options.Fields.NumberOfAssociatedTvChannels",
                ...
                ["Admin.Catalog.Attributes.SpecificationAttributes.UsedByTvChannels"] = "Admin.Catalog.Attributes.SpecificationAttributes.SpecificationAttribute.UsedByTvChannels",
                ["Admin.Catalog.Attributes.SpecificationAttributes.UsedByTvChannels.TvChannel"] = "Admin.Catalog.Attributes.SpecificationAttributes.SpecificationAttribute.UsedByTvChannels.TvChannel",
                ["Admin.Catalog.Attributes.SpecificationAttributes.UsedByTvChannels.Published"] = "Admin.Catalog.Attributes.SpecificationAttributes.SpecificationAttribute.UsedByTvChannels.Published",
                ...
                //#4564
                ["TvProg.Web.Framework.Validators.MaxDecimal"] = "Admin.Common.Validation.Decimal.Max",

                //#5321
                ["Common.Wait..."] = "Common.Wait",

                //#5429
                ["Search.NoResultsText"] = "Catalog.TvChannels.NoResult"
