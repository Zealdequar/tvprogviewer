...
namespace TVProgViewer.WebUI.MainServiceReferences {
    ...
    public interface IMainService {
        ...
        System.Collections.Generic.KeyValuePair<int, TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[]> GetUserProgrammeList(long uid, int typeProgID, System.DateTimeOffset dateTimeOffset, int mode, string category, string sidx, string sord, int page, int rows);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMainService/GetUserProgrammeList", ReplyAction="http://tempuri.org/IMainService/GetUserProgrammeListResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.KeyValuePair<int, TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[]>> GetUserProgrammeListAsync(long uid, int typeProgID, System.DateTimeOffset dateTimeOffset, int mode, string category, string sidx, string sord, int page, int rows);
        ...
        System.Collections.Generic.KeyValuePair<int, TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[]> SearchProgramme(int typeProgID, string findTitle, string sidx, string sord, int page, int rows);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMainService/SearchProgramme", ReplyAction="http://tempuri.org/IMainService/SearchProgrammeResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.KeyValuePair<int, TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[]>> SearchProgrammeAsync(int typeProgID, string findTitle, string sidx, string sord, int page, int rows);
    ...
    public partial class MainServiceClient : System.ServiceModel.ClientBase<TVProgViewer.WebUI.MainServiceReferences.IMainService>, TVProgViewer.WebUI.MainServiceReferences.IMainService {
        ...
        public System.Collections.Generic.KeyValuePair<int, TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[]> GetUserProgrammeList(long uid, int typeProgID, System.DateTimeOffset dateTimeOffset, int mode, string category, string sidx, string sord, int page, int rows) {
            return base.Channel.GetUserProgrammeList(uid, typeProgID, dateTimeOffset, mode, category, sidx, sord, page, rows);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.KeyValuePair<int, TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[]>> GetUserProgrammeListAsync(long uid, int typeProgID, System.DateTimeOffset dateTimeOffset, int mode, string category, string sidx, string sord, int page, int rows) {
            return base.Channel.GetUserProgrammeListAsync(uid, typeProgID, dateTimeOffset, mode, category, sidx, sord, page, rows);
        }
        ...
        public System.Collections.Generic.KeyValuePair<int, TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[]> SearchProgramme(int typeProgID, string findTitle, string sidx, string sord, int page, int rows) {
            return base.Channel.SearchProgramme(typeProgID, findTitle, sidx, sord, page, rows);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.KeyValuePair<int, TVProgViewer.BusinessLogic.ProgObjs.SystemProgramme[]>> SearchProgrammeAsync(int typeProgID, string findTitle, string sidx, string sord, int page, int rows) {
            return base.Channel.SearchProgrammeAsync(typeProgID, findTitle, sidx, sord, page, rows);
        }
