...
function setGrid()
{
    ...
    $("#tblUserChannels").jqGrid({
        ...
        mtype: "Get",
        success: function () { },
        colNames: ["","","Вкл./Выкл.", "Логотип", "Канал", "Пользовательское название", "Номер канала", "Сдвиг по времени"],
        colModel: [
            {
                key: true, name: "UserChannelID", index: "UserChannelID", width: "0px", hidden: true, editable: true 
            },
            {
                key: false, name: "ChannelID", index: "ChannelID", width: "0px", hidden: true, editable: true
            },
            {
