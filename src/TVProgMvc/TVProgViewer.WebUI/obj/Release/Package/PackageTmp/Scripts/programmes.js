    ...
    $('#TVProgrammeNowGrid').jqGrid(
        {
            ...
            mtype: 'Get',
            success: function () { },
            colNames: ["Жанр", "Название жранра", "Анонс", "Эмблема канала", "Название канала", "Передача", "Начало", "Окончание", "Осталось, %", ""],
            colModel: [
                {
                    key: false, name: 'GenreContent', index: 'GenreContent', sortable: true, width: "2%", align: "center", formatter: function (s) {
                        if (s)
                            return "<img src='" + s + "' alt='Жанр' />";
                        return " ";
                    },
                ...
                {
                    key: false, name: 'AnonsContent', index: 'AnonsContent', sortable: true, width: "2%", align: "center", formatter: function (s) {
                        if (s)
                            return "<img src='" + s + "' alt='Анонс' />";
                        return " ";
                    }
                },
                {
                    key: false, name: 'ChannelContent', index: 'ChannelContent', sortable: true, width: "3%", align: "center", formatter: function (s) {
                        if (s) {
                            return "<img src='" + s + "' alt='Эмблема канала' />";
                        }
    ...
    $('#TVProgrammeNextGrid').jqGrid(
        {
            ...
            datatype: 'json',
            mtype: 'Get',
            colNames: ["Жанр", "Название жанра", "Анонс", "Эмблема канала", "Название канала", "Передача", "Начало", "Окончание", "Осталось", ""],
            colModel: [
                {
                    key: false, name: 'GenreContent', index: 'GenreContent', sortable: true, width: 40, align: "center", formatter: function (s) {
                        if (s)
                            return "<img src='" + s + "' alt='Жанр' />";
                        return " ";
                    },
                ...
                {
                    key: false, name: 'AnonsContent', index: 'AnonsContent', sortable: true, width: 40, align: "center", formatter: function (s) {
                        if (s)
                            return "<img src='" + s + "' alt='Анонс' />";
                        return " ";
                    }
                ...
                {
                    key: false, name: 'ChannelContent', index: 'ChannelContent', sortable: true, width: 80, align: "center", formatter: function (s) {
                        if (s) {
                            return "<img src='" + s + "' alt='Эмблема канала' />";
                        }
                        return "<img src='/imgs/i/satellite_25.png' alt='Эмблема канала' />";
    ...
    $('#SearchedTVProgramme').jqGrid(
        {
            ...
            datatype: 'json',
            mtype: 'Get',
            colNames: ["Жанр", "Название жанра", "Анонс", "Эмблема канала", "Название канала", "День", "От", "До", "Передачи"],
            colModel: [
                {
                    key: false, name: 'GenreContent', index: 'GenreContent', sortable: true, width: "46px", align: "center", formatter: function (s) {
                        if (s)
                            return "<img src='" + s + "' alt='Жанр' />";
                        return " ";
                    },
                ...
                {
                    key: false, name: 'AnonsContent', index: 'AnonsContent', sortable: true, width: "43px", align: "center", formatter: function (s) {
                        if (s)
                            return "<img src='" + s + "' alt='Анонс' />";
                        return " ";
                    }
                ...
                {
                    key: false, name: 'ChannelContent', index: 'ChannelContent', sortable: true, align: "center", formatter: function (s) {
                        if (s) {
                            return "<img src='" + s + "' alt='Эмблема канала' />";
                        }
                        return "<img src='/imgs/i/satellite_25.png' alt='Эмблема канала' />";
    ...
    $('#TVProgrammeByDaysGrid').jqGrid(
        {
            ...
            datatype: 'json',
            mtype: 'Get',
            colNames: ["Жанр", "Название жанра", "Анонс", "От", "До", "Передача", ""],
            colModel: [
                {
                    key: false, name: 'GenreContent', index: 'GenreContent', sortable: true, width: 40, align: "center", formatter: function (s) {
                        if (s)
