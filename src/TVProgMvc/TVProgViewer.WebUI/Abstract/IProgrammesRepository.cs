...
namespace TVProgViewer.WebUI.Abstract
{
    public interface IProgrammesRepository
    {
        ...
        /// <param name="dateTimeOffset">Время</param>
        /// <param name="category">Категория</param>
        Task<KeyValuePair<int, SystemProgramme[]>> GetUserProgrammesAtNowAsyncList(long uid, int typeProgID, DateTimeOffset dateTimeOffset, string category, string sidx, string sord, int page, int rows);
        ...
        /// <param name="dateTimeOffset">Текущее время</param>
        /// <param name="category">Категория</param>
        Task<KeyValuePair<int, SystemProgramme[]>> GetUserProgrammesAtNextAsyncList(long uid, int typeProgID, DateTimeOffset dateTimeOffset, string category,
            string sidx, string sord, int page, int rows);
        ...
        Task<KeyValuePair<int, SystemProgramme[]>> SearchProgramme(int typeProgID, string findTitle, string sidx, string sord, int page, int rows);
