		...
		public SourceCollection VideoSources
		{
			...
			{ 
				if ( videoSources == null )
				{
					...
					catch ( Exception ex ) { Debug.WriteLine( "Видеоисточники: невозможно создать видеоисточники." + ex.ToString() ); }
				}
				return ( videoSources );
			}
            set
...
//#endif
		...
		public Capture(Filter videoDevice, Filter audioDevice, bool audioViaPci)
        {
			if ( videoDevice == null && audioDevice == null )
				throw new ArgumentException( "Видеоустройство и/или аудиоустройство должно быть установлено в действительный фильтр.\n" );
...
// #endif
		...
		/// </summary>
#if DSHOWNET
		protected TVFineTune.IAMTVAudio tvAudio = null;
#else
		...
		/// </summary>
#if DSHOWNET
		public TVFineTune.IAMTVAudio TvAudio
#else
