...
namespace TVProgViewer.Data.Mapping.Forums
{
    ...
    /// </summary>
    public partial class ForumTopicMap : TvProgEntityTypeConfiguration<ForumTopic>
    {
        #region Methods
        ...
        public override void Configure(EntityMappingBuilder<ForumTopic> builder)
        {
            ...
            builder.Property(forumtopic => forumtopic.LastPostUserId);
