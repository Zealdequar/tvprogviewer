...
namespace TVProgViewer.Data.Mapping.Shipping
{
    ...
    /// </summary>
    public partial class ShippingMethodCountryMap : TvProgEntityTypeConfiguration<ShippingMethodCountryMapping>
    {
        #region Methods
        ...
        {
            builder.HasTableName(TvProgMappingDefaults.ShippingMethodRestrictionsTable);
