...
namespace TVProgViewer.Data.Mapping.Polls
{
    /// <summary>
    /// Represents a poll voting record mapping configuration
    /// </summary>
    public partial class PollVotingRecordMap : TvProgEntityTypeConfiguration<PollVotingRecord>
    {
        #region Methods
        ...
        public override void Configure(EntityMappingBuilder<PollVotingRecord> builder)
        {
            ...
            builder.Property(pollvotingrecord => pollvotingrecord.UserId);
