...
namespace TVProgViewer.Data.Mapping.Catalog
{
    ...
    /// </summary>
    public partial class ProductProductTagMap : TvProgEntityTypeConfiguration<ProductProductTagMapping>
    {
        #region Methods
        ...
        {
            builder.HasTableName(TvProgMappingDefaults.ProductProductTagTable);
