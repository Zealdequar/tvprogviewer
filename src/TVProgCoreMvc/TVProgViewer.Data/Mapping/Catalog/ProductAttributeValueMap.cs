...
namespace TVProgViewer.Data.Mapping.Catalog
{
    ...
    /// </summary>
    public partial class ProductAttributeValueMap : TvProgEntityTypeConfiguration<ProductAttributeValue>
    {
        #region Methods
        ...
        public override void Configure(EntityMappingBuilder<ProductAttributeValue> builder)
        {
            ...
            builder.Property(productattributevalue => productattributevalue.UserEntersQty);
