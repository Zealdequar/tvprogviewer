...
namespace TVProgViewer.Data.Mapping.Catalog
{
    ...
    /// </summary>
    public partial class ProductAttributeCombinationMap : TvProgEntityTypeConfiguration<ProductAttributeCombination>
    {
        #region Methods
        ...
        public override void Configure(EntityMappingBuilder<ProductAttributeCombination> builder)
        {
            ...
            builder.Property(combination => combination.OverriddenPrice.Value).HasDecimal();
