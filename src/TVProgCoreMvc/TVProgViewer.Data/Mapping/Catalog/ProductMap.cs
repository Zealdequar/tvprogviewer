...
namespace TVProgViewer.Data.Mapping.Catalog
{
    ...
    /// </summary>
    public partial class ProductMap : TvProgEntityTypeConfiguration<Product>
    {
        #region Methods
        ...
        public override void Configure(EntityMappingBuilder<Product> builder)
        {
            ...
            builder.Property(product => product.MinimumUserEnteredPrice).HasDecimal();
            builder.Property(product => product.MaximumUserEnteredPrice).HasDecimal();
            ...
            builder.Property(product => product.OverriddenGiftCardAmount).HasDecimalNullable();
            ...
            builder.Property(product => product.AllowUserReviews);
            ...
            builder.Property(product => product.UserEntersPrice);
