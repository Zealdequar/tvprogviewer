...
namespace TVProgViewer.Data.Mapping.Catalog
{
    ...
    /// Mapping class
    /// </summary>
    public partial class ProductReviewReviewTypeMappingMap : TvProgEntityTypeConfiguration<ProductReviewReviewTypeMapping>
    {
        #region Methods
        ...
        {
            builder.HasTableName(TvProgMappingDefaults.ProductReviewReviewTypeTable);
