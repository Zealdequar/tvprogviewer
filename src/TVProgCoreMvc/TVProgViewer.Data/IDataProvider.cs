...
namespace TVProgViewer.Data
{
    ...
    public partial interface IDataProvider
    {
        ...
        /// </summary>
        /// <param name="TVProgViewerConnectionString">Connection string info</param>
        /// <returns>Connection string</returns>
        string BuildConnectionString(ITVProgViewerConnectionStringInfo TVProgViewerConnectionString);
