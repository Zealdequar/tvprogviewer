...
namespace TVProgViewer.Web.Framework.TagHelpers.Public
{
    ...
    public class ScriptTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (_httpContextAccessor.HttpContext.Items["TVProgViewer.IgnoreScriptTagLocation"] != null &&
                Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["TVProgViewer.IgnoreScriptTagLocation"]))
                return;
