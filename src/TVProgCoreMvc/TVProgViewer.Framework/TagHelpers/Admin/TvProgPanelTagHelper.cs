...
namespace TVProgViewer.Web.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("tvprog-panel", Attributes = NAME_ATTRIBUTE_NAME)]
    public class TvProgPanelTagHelper : TagHelper
    {
        ...
        public TvProgPanelTagHelper(IHtmlHelper htmlHelper)
        {
