...
{
    /// <summary>
    /// TVProgViewer-tabs tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-tabs", Attributes = IdAttributeName)]
    public class TvProgTabsTagHelper : TagHelper
    {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<TVProgViewerTabContextItem>();
    ...
    /// <summary>
    /// "TVProgViewer-tab tag helper
    /// </summary>
    [HtmlTargetElement("tvprog-tab", ParentTag = "tvprog-tabs", Attributes = NameAttributeName)]
    public class TVProgViewerTabTagHelper : TagHelper
    {
        ...
        /// </summary>
        /// <param name="htmlHelper">HTML helper</param>
        public TVProgViewerTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<TVProgViewerTabContextItem>)context.Items[typeof(TvProgTabsTagHelper)];
            tabContext.Add(new TVProgViewerTabContextItem()
            {
    ...
    /// Tab context item
    /// </summary>
    public class TVProgViewerTabContextItem
    {
        /// <summary>
        /// Title
        /// </summary>
