...
namespace TVProgViewer.Web.Framework.Controllers
{
    ...
    public abstract class BaseController : Controller
    {
        ...
        public virtual void SaveSelectedPanelName(string tabName, bool persistForTheNextRequest = true)
        {
            ...
            //"GetSelectedPanelName" method of \TVProgViewer.Web.Framework\Extensions\HtmlExtensions.cs
            if (string.IsNullOrEmpty(tabName))
                throw new ArgumentNullException(nameof(tabName));

            const string dataKey = "TVProgViewer.selected-panel-name";
        ...
        {
            //keep this method synchronized with
            //"GetSelectedTabName" method of \TVProgViewer.Web.Framework\Extensions\HtmlExtensions.cs
            if (string.IsNullOrEmpty(tabName))
            {
            ...
            var dataKey = "TVProgViewer.selected-tab-name";
        ...
        public JsonResult Json<T>(BasePagedListModel<T> model) where T : BaseTvProgModel
        {
            return Json(new
            {
                draw = model.Draw,
