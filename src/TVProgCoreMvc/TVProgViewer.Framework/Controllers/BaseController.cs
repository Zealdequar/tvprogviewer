...
namespace TVProgViewer.Web.Framework.Controllers
{
    ...
    public abstract class BaseController : Controller
    {
        ...
        public virtual void SaveSelectedCardName(string cardName, bool persistForTheNextRequest = true)
        {
            ...
            //"GetSelectedCardName" method of \TvProg.Web.Framework\Extensions\HtmlExtensions.cs
        ...
        {
            //keep this method synchronized with
            //"GetSelectedTabName" method of \TvProg.Web.Framework\Extensions\HtmlExtensions.cs
