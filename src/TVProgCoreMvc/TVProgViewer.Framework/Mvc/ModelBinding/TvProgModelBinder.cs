...
{
    /// <summary>
    /// Represents model binder for the binding models inherited from the BaseTvProgModel
    /// </summary>
    public class TvProgModelBinder : ComplexTypeModelBinder
    {
        #region Ctor
        ...
        public TvProgModelBinder(IDictionary<ModelMetadata, IModelBinder> propertyBinders, ILoggerFactory loggerFactory)
        ...
        protected override object CreateModel(ModelBindingContext bindingContext)
        {
            ...
            if (model is BaseTvProgModel)
                (model as BaseTvProgModel).BindModel(bindingContext);
            ...
            ModelMetadata propertyMetadata, ModelBindingResult bindingResult)
        {
            ...
            //trim property string values for TVProgViewer models
            var valueAsString = bindingResult.Model as string;
            if (bindingContext.Model is BaseTvProgModel && !string.IsNullOrEmpty(valueAsString))
            {
