...
{
    /// <summary>
    /// A class that finds types needed by TVProgViewer by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets whether TVProgViewer should iterate assemblies in the app domain when loading TVProgViewer types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that TVProgViewer assemblies aren't investigated (e.g. by not including something like "^TVProgViewer|..." you may break core functionality.</remarks>
