...
namespace TVProgViewer.WebUI.Factories
{
    ...
    public partial class BlogModelFactory : IBlogModelFactory
    {
        ...
        {
            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(TvProgModelCacheDefaults.BlogMonthsModelKey, await _workContext.GetWorkingLanguageAsync(), await _storeContext.GetCurrentStoreAsync());
