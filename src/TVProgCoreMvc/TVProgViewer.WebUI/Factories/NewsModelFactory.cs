...
namespace TVProgViewer.WebUI.Factories
{
    ...
    public partial class NewsModelFactory : INewsModelFactory
    {
        ...
        {
            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(TvProgModelCacheDefaults.HomepageNewsModelKey, await _workContext.GetWorkingLanguageAsync(), await _storeContext.GetCurrentStoreAsync());
