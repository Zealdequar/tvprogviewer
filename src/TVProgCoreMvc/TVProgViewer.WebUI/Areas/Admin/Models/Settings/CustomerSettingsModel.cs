...
namespace TVProgViewer.WebUI.Areas.Admin.Models.Settings
{
    ...
    public partial record UserSettingsModel : BaseTvProgModel, ISettingsModel
    {
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.UserUser.DateOfBirthEnabled")]
        public bool DateOfBirthEnabled { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.UserUser.DateOfBirthRequired")]
        public bool DateOfBirthRequired { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.UserUser.DateOfBirthMinimumAge")]
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.UserUser.PhoneEnabled")]
        public bool PhoneEnabled { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.UserUser.PhoneRequired")]
