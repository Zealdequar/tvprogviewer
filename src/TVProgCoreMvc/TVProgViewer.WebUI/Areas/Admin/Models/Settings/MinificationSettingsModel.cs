...
namespace TVProgViewer.WebUI.Areas.Admin.Models.Settings
{
    ...
    public partial record MinificationSettingsModel : BaseTvProgModel, ISettingsModel
    {
        ...
        [TvProgResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.EnableJsBundling")]
        public bool EnableJsBundling { get; set; }
        public bool EnableJsBundling_OverrideForStore { get; set; }

        [TvProgResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.EnableCssBundling")]
