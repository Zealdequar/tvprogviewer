...
namespace TVProgViewer.WebUI.Areas.Admin.Factories
{
    ...
    public partial class SettingModelFactory : ISettingModelFactory
    {
        ...
        protected virtual UserSettingsModel PrepareUserSettingsModel()
        {
            //load settings for a chosen store scope
            var storeId = _storeContext.ActiveStoreScopeConfiguration;
            var userSettings = _settingService.LoadSetting<UserSettings>(storeId);
        ...
        protected virtual StoreInformationSettingsModel PrepareStoreInformationSettingsModel()
        {
            ...
            model.AllowUserToSelectTheme_OverrideForStore = _settingService.SettingExists(storeInformationSettings, x => x.AllowUserToSelectTheme, storeId);
        ...
        protected virtual DisplayDefaultMenuItemSettingsModel PrepareDisplayDefaultMenuItemSettingsModel()
        {
            ...
            model.DisplayUserInfoMenuItem_OverrideForStore = _settingService.SettingExists(displayDefaultMenuItemSettings, x => x.DisplayUserInfoMenuItem, storeId);
        ...
        protected virtual DisplayDefaultFooterItemSettingsModel PrepareDisplayDefaultFooterItemSettingsModel()
        {
            ...
            model.DisplayUserInfoFooterItem_OverrideForStore = _settingService.SettingExists(displayDefaultFooterItemSettings, x => x.DisplayUserInfoFooterItem, storeId);
            model.DisplayUserOrdersFooterItem_OverrideForStore = _settingService.SettingExists(displayDefaultFooterItemSettings, x => x.DisplayUserOrdersFooterItem, storeId);
            model.DisplayUserAddressesFooterItem_OverrideForStore = _settingService.SettingExists(displayDefaultFooterItemSettings, x => x.DisplayUserAddressesFooterItem, storeId);
        ...
        public virtual VendorSettingsModel PrepareVendorSettingsModel()
        {
            ...
            if (storeId > 0)
            {
                ...
                model.AllowUsersToContactVendors_OverrideForStore = _settingService.SettingExists(vendorSettings, x => x.AllowUsersToContactVendors, storeId);
                model.AllowUsersToApplyForVendorAccount_OverrideForStore = _settingService.SettingExists(vendorSettings, x => x.AllowUsersToApplyForVendorAccount, storeId);
        ...
        public virtual ForumSettingsModel PrepareForumSettingsModel()
        {
            ...
            model.ShowUsersPostCount_OverrideForStore = _settingService.SettingExists(forumSettings, x => x.ShowUsersPostCount, storeId);
            ...
            model.AllowUsersToEditPosts_OverrideForStore = _settingService.SettingExists(forumSettings, x => x.AllowUsersToEditPosts, storeId);
            model.AllowUsersToDeletePosts_OverrideForStore = _settingService.SettingExists(forumSettings, x => x.AllowUsersToDeletePosts, storeId);
            ...
            model.AllowUsersToManageSubscriptions_OverrideForStore = _settingService.SettingExists(forumSettings, x => x.AllowUsersToManageSubscriptions, storeId);
        ...
        public virtual ShippingSettingsModel PrepareShippingSettingsModel()
        {
            ...
            if (storeId > 0)
            {
                ...
                model.NotifyUserAboutShippingFromMultipleLocations_OverrideForStore = _settingService.SettingExists(shippingSettings, x => x.NotifyUserAboutShippingFromMultipleLocations, storeId);
                ...
                model.DisplayShipmentEventsToUsers_OverrideForStore = _settingService.SettingExists(shippingSettings, x => x.DisplayShipmentEventsToUsers, storeId);
        ...
        public virtual TaxSettingsModel PrepareTaxSettingsModel()
        {
            ...
            if (storeId > 0)
            {
                ...
                model.AllowUsersToSelectTaxDisplayType_OverrideForStore = _settingService.SettingExists(taxSettings, x => x.AllowUsersToSelectTaxDisplayType, storeId);
        ...
        public virtual CatalogSettingsModel PrepareCatalogSettingsModel()
        {
            ...
            if (storeId > 0)
            {
                ...
                model.NotifyUserAboutProductReviewReply_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.NotifyUserAboutProductReviewReply, storeId);
                ...
                model.SearchPageAllowUsersToSelectPageSize_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.SearchPageAllowUsersToSelectPageSize, storeId);
                ...
                model.ProductsByTagAllowUsersToSelectPageSize_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.ProductsByTagAllowUsersToSelectPageSize, storeId);
