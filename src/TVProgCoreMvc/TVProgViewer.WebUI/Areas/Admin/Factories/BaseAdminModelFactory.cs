...
namespace TVProgViewer.WebUI.Areas.Admin.Factories
{
    ...
    public partial class BaseAdminModelFactory : IBaseAdminModelFactory
    {
        ...
        {
            var cacheKey =TvProgModelCacheDefaults.CategoriesListKey.FillCacheKey(showHidden);
        ...
        {
            var cacheKey = TvProgModelCacheDefaults.ManufacturersListKey.FillCacheKey(showHidden);
            var listItems = _cacheManager.Get(cacheKey, () =>
            {
        ...
        {
            var cacheKey = TvProgModelCacheDefaults.VendorsListKey.FillCacheKey(showHidden);
            var listItems = _cacheManager.Get(cacheKey, () =>
            {
