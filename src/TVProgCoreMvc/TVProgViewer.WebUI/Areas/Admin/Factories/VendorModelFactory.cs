...
namespace TVProgViewer.WebUI.Areas.Admin.Factories
{
    ...
    public partial class VendorModelFactory : IVendorModelFactory
    {
        ...
        protected virtual void PrepareAssociatedUserModels(IList<VendorAssociatedUserModel> models, Vendor vendor)
        {
            if (models == null)
            ...
            var associatedUsers = _userService.GetAllUsers(vendorId: vendor.Id);
        ...
        protected virtual void PrepareVendorAttributeModels(IList<VendorModel.VendorAttributeModel> models, Vendor vendor)
        {
            ...
            foreach (var attribute in vendorAttributes)
            {
                ...
                if (vendor != null)
                {
                    var selectedVendorAttributes = _genericAttributeService.GetAttribute<string>(vendor, TvProgVendorDefaults.VendorAttributes);
        ...
        public virtual VendorModel PrepareVendorModel(VendorModel model, Vendor vendor, bool excludeProperties = false)
        {
            ...
            if (vendor != null)
            {
                ...
                PrepareAssociatedUserModels(model.AssociatedUsers, vendor);
