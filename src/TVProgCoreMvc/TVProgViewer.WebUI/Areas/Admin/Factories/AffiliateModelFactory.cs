...
namespace TVProgViewer.WebUI.Areas.Admin.Factories
{
    ...
    public partial class AffiliateModelFactory : IAffiliateModelFactory
    {
        ...
        public virtual AffiliatedUserListModel PrepareAffiliatedUserListModel(AffiliatedUserSearchModel searchModel,
            Affiliate affiliate)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
            ...
            //get users
            var users = _userService.GetAllUsers(affiliateId: affiliate.Id,
                pageIndex: searchModel.Page - 1, pageSize: searchModel.PageSize);
