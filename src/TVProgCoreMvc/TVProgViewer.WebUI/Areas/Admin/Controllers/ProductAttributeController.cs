...
namespace TVProgViewer.WebUI.Areas.Admin.Controllers
{
    public partial class ProductAttributeController : BaseAdminController
    {
        ...
        public ProductAttributeController(IUserActivityService userActivityService,
        ...
        public virtual async Task<IActionResult> Create(ProductAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                await _userActivityService.InsertActivityAsync("AddNewProductAttribute",
        ...
        public virtual async Task<IActionResult> Edit(ProductAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                await _userActivityService.InsertActivityAsync("EditProductAttribute",
        ...
        public virtual async Task<IActionResult> Delete(int id)
        {
            ...
            //activity log
            await _userActivityService.InsertActivityAsync("DeleteProductAttribute",
