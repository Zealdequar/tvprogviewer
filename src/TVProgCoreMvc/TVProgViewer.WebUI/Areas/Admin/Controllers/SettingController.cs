...
namespace TVProgViewer.WebUI.Areas.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
    {
        ...
        public virtual IActionResult ChangeStoreScopeConfiguration(int storeid, string returnUrl = "")
        {
            ...
            if (store != null || storeid == 0)
            {
                _genericAttributeService
                    .SaveAttribute(_workContext.CurrentUser, TvProgUserDefaults.AdminAreaStoreScopeConfigurationAttribute, storeid);
            }
        ...
        public virtual IActionResult Vendor(VendorSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(vendorSettings, x => x.AllowUsersToContactVendors, model.AllowUsersToContactVendors_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(vendorSettings, x => x.AllowUsersToApplyForVendorAccount, model.AllowUsersToApplyForVendorAccount_OverrideForStore, storeScope, false);
        ...
        public virtual IActionResult Forum(ForumSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(forumSettings, x => x.ShowUsersPostCount, model.ShowUsersPostCount_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(forumSettings, x => x.AllowUsersToEditPosts, model.AllowUsersToEditPosts_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(forumSettings, x => x.AllowUsersToDeletePosts, model.AllowUsersToDeletePosts_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(forumSettings, x => x.AllowUsersToManageSubscriptions, model.AllowUsersToManageSubscriptions_OverrideForStore, storeScope, false);
        ...
        public virtual IActionResult Shipping(ShippingSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(shippingSettings, x => x.NotifyUserAboutShippingFromMultipleLocations, model.NotifyUserAboutShippingFromMultipleLocations_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(shippingSettings, x => x.DisplayShipmentEventsToUsers, model.DisplayShipmentEventsToUsers_OverrideForStore, storeScope, false);
        ...
        public virtual IActionResult Tax(TaxSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(taxSettings, x => x.AllowUsersToSelectTaxDisplayType, model.AllowUsersToSelectTaxDisplayType_OverrideForStore, storeScope, false);
        ...
        public virtual IActionResult Catalog(CatalogSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.NotifyUserAboutProductReviewReply, model.NotifyUserAboutProductReviewReply_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.SearchPageAllowUsersToSelectPageSize, model.SearchPageAllowUsersToSelectPageSize_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.ProductsByTagAllowUsersToSelectPageSize, model.ProductsByTagAllowUsersToSelectPageSize_OverrideForStore, storeScope, false);
        ...
        public virtual IActionResult UserUser(UserUserSettingsModel model)
        {
            ...
            if (userSettings.UsernameValidationEnabled && userSettings.UsernameValidationUseRegex)
            {
                ...
                catch (ArgumentException)
                {
                    ...
                    _notificationService.ErrorNotification(_localizationService.GetResource("Admin.Configuration.Settings.UserSettings.RegexValidationRule.Error"));
                }
            }
        ...
        public virtual IActionResult GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(displayDefaultFooterItemSettings, x => x.DisplayUserInfoFooterItem, model.DisplayDefaultFooterItemSettings.DisplayUserInfoFooterItem_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(displayDefaultFooterItemSettings, x => x.DisplayUserOrdersFooterItem, model.DisplayDefaultFooterItemSettings.DisplayUserOrdersFooterItem_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(displayDefaultFooterItemSettings, x => x.DisplayUserAddressesFooterItem, model.DisplayDefaultFooterItemSettings.DisplayUserAddressesFooterItem_OverrideForStore, storeScope, false);
        ...
        public virtual IActionResult ChangeEncryptionKey(GeneralCommonSettingsModel model)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(newEncryptionPrivateKey) || newEncryptionPrivateKey.Length != 16)
                    throw new TvProgException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.EncryptionKey.TooShort"));

                var oldEncryptionPrivateKey = securitySettings.EncryptionKey;
                if (oldEncryptionPrivateKey == newEncryptionPrivateKey)
                    throw new TvProgException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.EncryptionKey.TheSame"));
        ...
        public virtual IActionResult ToggleFullText(GeneralCommonSettingsModel model)
        {
            ...
            try
            {
                if (!_fulltextService.IsFullTextSupported())
                    throw new TvProgException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.FullTextSettings.NotSupported"));
        ...
        public virtual IActionResult UploadIconsArchive(IFormFile archivefile)
        {
            ...
            try
            {
                ...
                var headCodePath = _fileProvider.GetAbsolutePath(string.Format(TvProgCommonDefaults.FaviconAndAppIconsPath, _storeContext.ActiveStoreScopeConfiguration), TvProgCommonDefaults.HeadCodeFileName);

                if (!_fileProvider.FileExists(headCodePath))
                {
                    throw new Exception(string.Format(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.FaviconAndAppIcons.MissingFile"), TvProgCommonDefaults.HeadCodeFileName));
                }
                ...
                var oldFaviconIconPath = _fileProvider.GetAbsolutePath(string.Format(TvProgCommonDefaults.OldFaviconIconName, _storeContext.ActiveStoreScopeConfiguration));
                ...
                //activity log
                _userActivityService.InsertActivity("UploadIconsArchive", string.Format(_localizationService.GetResource("ActivityLog.UploadNewIconsArchive"), _storeContext.ActiveStoreScopeConfiguration));
