    ...
    public partial class ManufacturerController : BaseAdminController
    {
            ...
            foreach (var userRole in allUserRoles)
            {
                if (model.SelecteduserRoleIds.Contains(userRole.Id))
                {
                    ...
                    if (existingAclRecords.Count(acl => acl.UserRoleId == userRole.Id) == 0)
                        _aclService.InsertAclRecord(manufacturer, userRole.Id);
                }
                else
                {
                    //remove role
        ...
        public virtual IActionResult Create(ManufacturerModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("AddNewManufacturer",
        ...
        public virtual IActionResult Edit(ManufacturerModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("EditManufacturer",
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            //activity log
            _userActivityService.InsertActivity("DeleteManufacturer",
