    ...
    public partial class ProductController : BaseAdminController
    {
            ...
            foreach (var userRole in allUserRoles)
            {
                if (model.SelecteduserRoleIds.Contains(userRole.Id))
                {
                    ...
                    if (existingAclRecords.Count(acl => acl.UserRoleId == userRole.Id) == 0)
                        _aclService.InsertAclRecord(product, userRole.Id);
                }
                else
                {
                    //remove role
        ...
        protected virtual void GenerateAttributeCombinations(Product product, IList<int> allowedAttributeIds = null)
        {
            ...
            foreach (var attributesXml in allAttributesXml)
            {
                ...
                warnings.AddRange(_shoppingCartService.GetShoppingCartItemAttributeWarnings(_workContext.CurrentUser,
        ...
        public virtual IActionResult Create(ProductModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("AddNewProduct",
        ...
        public virtual IActionResult Edit(ProductModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("EditProduct",
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            //activity log
            _userActivityService.InsertActivity("DeleteProduct",
