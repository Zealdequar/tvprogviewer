...
namespace TVProgViewer.WebUI.Areas.Admin.Controllers
{
    public partial class VendorAttributeController : BaseAdminController
    {
        ...
        public VendorAttributeController(IUserActivityService userActivityService,
        ...
        public virtual async Task<IActionResult> Create(VendorAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                await _userActivityService.InsertActivityAsync("AddNewVendorAttribute",
        ...
        public virtual async Task<IActionResult> Edit(VendorAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                await _userActivityService.InsertActivityAsync("EditVendorAttribute",
        ...
        public virtual async Task<IActionResult> Delete(int id)
        {
            ...
            //activity log
            await _userActivityService.InsertActivityAsync("DeleteVendorAttribute",
        ...
        public virtual async Task<IActionResult> ValueCreatePopup(VendorAttributeValueModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                await _userActivityService.InsertActivityAsync("AddNewVendorAttributeValue",
        ...
        public virtual async Task<IActionResult> ValueEditPopup(VendorAttributeValueModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                await _userActivityService.InsertActivityAsync("EditVendorAttributeValue",
        ...
        public virtual async Task<IActionResult> ValueDelete(int id)
        {
            ...
            //activity log
            await _userActivityService.InsertActivityAsync("DeleteVendorAttributeValue",
