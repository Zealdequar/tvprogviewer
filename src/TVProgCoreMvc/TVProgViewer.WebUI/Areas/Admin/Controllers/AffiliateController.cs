    ...
    public partial class AffiliateController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(AffiliateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("AddNewAffiliate",
        ...
        public virtual IActionResult Edit(AffiliateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("EditAffiliate",
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            //activity log
            _userActivityService.InsertActivity("DeleteAffiliate",
        ...
        [HttpPost]
        public virtual IActionResult AffiliatedUserList(AffiliatedUserSearchModel searchModel)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageAffiliates))
                return AccessDeniedDataTablesJson();
            ...
            //prepare model
            var model = _affiliateModelFactory.PrepareAffiliatedUserListModel(searchModel, affiliate);
