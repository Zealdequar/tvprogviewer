    ...
    public partial class AffiliateController : BaseAdminController
    {
        ...
        public virtual async Task<IActionResult> Create(AffiliateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                await _userActivityService.InsertActivityAsync("AddNewAffiliate",
        ...
        public virtual async Task<IActionResult> Edit(AffiliateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                await _userActivityService.InsertActivityAsync("EditAffiliate",
        ...
        public virtual async Task<IActionResult> Delete(int id)
        {
            ...
            //activity log
            await _userActivityService.InsertActivityAsync("DeleteAffiliate",
        ...
        [HttpPost]
        public virtual async Task<IActionResult> AffiliatedUserList(AffiliatedUserSearchModel searchModel)
        {
            if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageAffiliates))
                return await AccessDeniedDataTablesJson();
            ...
            //prepare model
            var model = await _affiliateModelFactory.PrepareAffiliatedUserListModelAsync(searchModel, affiliate);
