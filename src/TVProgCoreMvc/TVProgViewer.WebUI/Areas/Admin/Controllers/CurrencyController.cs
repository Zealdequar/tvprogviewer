    ...
    public partial class CurrencyController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(CurrencyModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("AddNewCurrency",
        ...
        public virtual IActionResult Edit(CurrencyModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("EditCurrency",
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            try
            {
                if (currency.Id == _currencySettings.PrimaryStoreCurrencyId)
                    throw new TvProgException(_localizationService.GetResource("Admin.Configuration.Currencies.CantDeletePrimary"));

                if (currency.Id == _currencySettings.PrimaryExchangeRateCurrencyId)
                    throw new TvProgException(_localizationService.GetResource("Admin.Configuration.Currencies.CantDeleteExchange"));
                ...
                //activity log
                _userActivityService.InsertActivity("DeleteCurrency",
