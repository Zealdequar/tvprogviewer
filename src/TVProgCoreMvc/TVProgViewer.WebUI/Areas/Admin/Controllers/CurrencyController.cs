        ...
        public virtual async Task<IActionResult> Delete(int id)
        {
            ...
            try
            {
                if (currency.Id == _currencySettings.PrimaryStoreCurrencyId)
                    throw new TvProgException(await _localizationService.GetResourceAsync("Admin.Configuration.Currencies.CantDeletePrimary"));

                if (currency.Id == _currencySettings.PrimaryExchangeRateCurrencyId)
                    throw new TvProgException(await _localizationService.GetResourceAsync("Admin.Configuration.Currencies.CantDeleteExchange"));
