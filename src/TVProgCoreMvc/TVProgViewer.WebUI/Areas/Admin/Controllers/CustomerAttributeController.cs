...
namespace TVProgViewer.WebUI.Areas.Admin.Controllers
{
    public partial class UserAttributeController : BaseAdminController
    {
        ...
        public virtual IActionResult List()
        {
            ...
            SaveSelectedPanelName("usersettings-userformfields");
        ...
        public virtual IActionResult Create(UserAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notificationService.SuccessNotification(_localizationService.GetResource("Admin.Users.UserAttributes.Added"));
        ...
        public virtual IActionResult Edit(UserAttributeModel model, bool continueEditing)
        {
            ...
            _notificationService.SuccessNotification(_localizationService.GetResource("Admin.Users.UserAttributes.Updated"));
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            _notificationService.SuccessNotification(_localizationService.GetResource("Admin.Users.UserAttributes.Deleted"));
            return RedirectToAction("List");
        }
