...
namespace TVProgViewer.Services.Common
{
    ...
    public static partial class TvProgCommonDefaults
    {
        ...
        #region tvprogCommerce official site

        /// <summary>
        /// Gets a path to request the tvprog official site for copyright warning
        /// </summary>
        /// <remarks>
        /// {0} : store URL
        ...
        /// {2} : language code
        /// </remarks>
        public static string TvProgCopyrightWarningPath => "site-warnings?url={0}&local={1}&language={2}";

        /// <summary>
        /// Gets a path to request the tvprogCommerce official site for news RSS
        /// </summary>
        /// <remarks>
        /// {0} : tvprogCommerce version
        /// {1} : whether the store based is on the localhost
        ...
        /// <summary>
        /// Gets a path to request the tvprogCommerce official site to notify about successful installation
        /// </summary>
        /// <remarks>
        /// {0} : tvprogCommerce version
        /// {1} : whether the store based is on the localhost
        ...
        /// <summary>
        /// Gets a path to request the tvprogCommerce official site for available categories of marketplace extensions
        /// </summary>
        /// <remarks>
        /// {0} : language code
        /// </remarks>
        ...
        /// <summary>
        /// Gets a path to request the tvprogCommerce official site for available versions of marketplace extensions
        /// </summary>
        /// <remarks>
        /// {0} : language code
        /// </remarks>
        ...
        /// <summary>
        /// Gets a path to request the tvprogCommerce official site for marketplace extensions
        /// </summary>
        /// <remarks>
        ...
        /// {0} : address attribute ID
        /// </remarks>
        public static CacheKey AddressAttributeValuesByAttributeCacheKey => new CacheKey("TvProg.addressattributevalue.byattribute.{0}");
        ...
        /// {1} : key group
        /// </remarks>
        public static CacheKey GenericAttributeCacheKey => new CacheKey("TvProg.genericattribute.{0}-{1}");
