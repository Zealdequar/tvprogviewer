...
namespace TVProgViewer.Services.Common
{
    ...
    public partial class AddressAttributeService : IAddressAttributeService
    {
        ...
        public virtual IList<AddressAttribute> GetAllAddressAttributes()
        {
            ...
            return query.ToCachedList(TvProgCommonCachingDefaults.AddressAttributesAllCacheKey);
        }
        ...
        {
            var key = TvProgCommonCachingDefaults.AddressAttributeValuesAllCacheKey.FillCacheKey(addressAttributeId);
