...
namespace TVProgViewer.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        /// <returns>Queued email identifier</returns>
        IList<int> SendOrderPaidUserNotification(Order order, int languageId, 
        ...
        /// <param name="attachmentFileName">Attachment file name. If specified, then this file name will be sent to a recipient. Otherwise, "AttachmentFilePath" name will be used.</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendOrderPlacedUserNotification(Order order, int languageId, 
            string attachmentFilePath = null, string attachmentFileName = null);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendShipmentSentUserNotification(Shipment shipment, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendShipmentDeliveredUserNotification(Shipment shipment, int languageId);
        ...
        /// <param name="attachmentFileName">Attachment file name. If specified, then this file name will be sent to a recipient. Otherwise, "AttachmentFilePath" name will be used.</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendOrderCompletedUserNotification(Order order, int languageId, 
            string attachmentFilePath = null, string attachmentFileName = null);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendOrderCancelledUserNotification(Order order, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendOrderRefundedUserNotification(Order order, decimal refundedAmount, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendNewOrderNoteAddedUserNotification(OrderNote orderNote, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendRecurringPaymentCancelledUserNotification(RecurringPayment recurringPayment, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendRecurringPaymentFailedUserNotification(RecurringPayment recurringPayment, int languageId);
        ...
        /// <returns>Queued email identifier</returns>
        IList<int> SendProductEmailAFriendMessage(User User, int languageId, 
        ...
        /// <param name="personalMessage">Personal message</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendWishlistEmailAFriendMessage(User User, int languageId, 
        ...
        /// <param name="order">Order</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendNewReturnRequestUserNotification(ReturnRequest returnRequest, OrderItem orderItem, Order order);
        ...
        /// <param name="order">Order</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendReturnRequestStatusChangedUserNotification(ReturnRequest returnRequest, OrderItem orderItem, Order order);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendNewForumTopicMessage(User User, ForumTopic forumTopic, Forum forum, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendNewForumPostMessage(User User, ForumPost forumPost, 
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendNewVendorAccountApplyStoreOwnerNotification(User User, Vendor vendor, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendProductReviewReplyUserNotificationMessage(ProductReview productReview, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendNewVatSubmittedStoreOwnerNotification(User User, string vatName, string vatAddress, int languageId);
