...
namespace TVProgViewer.Services.Messages
{
    ...
    public partial class MessageTemplateService : IMessageTemplateService
    {
        ...
        public virtual IList<MessageTemplate> GetMessageTemplatesByName(string messageTemplateName, int? storeId = null)
        {
            ...
            var key = TvProgMessageCachingDefaults.MessageTemplatesByNameCacheKey.FillCacheKey(messageTemplateName, storeId);
        ...
        {
            var key = TvProgMessageCachingDefaults.MessageTemplatesAllCacheKey.FillCacheKey(storeId);
