namespace TVProgViewer.Core.Defaults
{
    /// <summary>
    ...
    public static partial class TvProgCommonDefaults
    {
        ...
        /// {2} : language code
        /// </remarks>
        public static string TVProgViewerCopyrightWarningPath => "site-warnings?url={0}&local={1}&language={2}";

        /// <summary>
        /// Gets a path to request the TvProg official site for news RSS
        /// </summary>
        /// <remarks>
        /// {0} : TvProg version
        /// {1} : whether the store based is on the localhost
        ...
        /// {4} : language code
        /// </remarks>
        public static string TVProgViewerNewsRssPath => "TVProgViewercommerce-news-rss?version={0}&localhost={1}&hideAdvertisements={2}&storeUrl={3}&language={4}";

        /// <summary>
        /// Gets a path to request the TvProg official site for available categories of marketplace extensions
        /// </summary>
        /// <remarks>
        /// {0} : language code
        /// </remarks>
        public static string TVProgViewerExtensionsCategoriesPath => "extensions-feed?getCategories=1&language={0}";

        /// <summary>
        /// Gets a path to request the TvProg official site for available versions of marketplace extensions
        /// </summary>
        /// <remarks>
        /// {0} : language code
        /// </remarks>
        public static string TVProgViewerExtensionsVersionsPath => "extensions-feed?getVersions=1&language={0}";

        /// <summary>
        /// Gets a path to request the TvProg official site for marketplace extensions
        /// </summary>
        /// <remarks>
        ...
        /// {6} : language code
        /// </remarks>
        public static string TVProgViewerExtensionsPath => "extensions-feed?category={0}&version={1}&price={2}&searchTerm={3}&pageIndex={4}&pageSize={5}&language={6}";
