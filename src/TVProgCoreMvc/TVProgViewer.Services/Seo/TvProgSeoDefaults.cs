...
namespace TVProgViewer.Services.Seo
{
    ...
    /// </summary>
    public static partial class TvProgSeoDefaults
    {
        /// <summary>
        ...
        /// {2} : language ID
        /// </remarks>
        public static CacheKey UrlRecordCacheKey => new CacheKey("TvProg.urlrecord.{0}-{1}-{2}");
        ...
        /// {0} : slug
        /// </remarks>
        public static CacheKey UrlRecordBySlugCacheKey => new CacheKey("TvProg.urlrecord.byslug.{0}");
