...
namespace TVProgViewer.Services.Plugins
{
    ...
    public partial class PluginsInfo : IPluginsInfo
    {
        ...
        public virtual void CopyFrom(IPluginsInfo pluginsInfo)
        {
            ...
            PluginNamesToInstall = pluginsInfo.PluginNamesToInstall?.ToList() ?? new List<(string SystemName, Guid? UserGuid)>();
        ...
        /// </summary>
        public virtual IList<(string SystemName, Guid? UserGuid)> PluginNamesToInstall { get; set; } = new List<(string SystemName, Guid? UserGuid)>();
