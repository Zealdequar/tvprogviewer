    ...
    public partial class ShippingService : IShippingService
    {
            ...
            bool includeCheckoutAttributes = true, bool ignoreFreeShippedItems = false)
        {
            ...
            if (request.User is null || !includeCheckoutAttributes)
                return totalWeight;
            var checkoutAttributesXml = await _genericAttributeService.GetAttributeAsync<string>(request.User, TvProgUserDefaults.CheckoutAttributes, (await _storeContext.GetCurrentStoreAsync()).Id);
        ...
        public virtual async Task<GetPickupPointsResponse> GetPickupPointsAsync(int addressId, User user = null,
