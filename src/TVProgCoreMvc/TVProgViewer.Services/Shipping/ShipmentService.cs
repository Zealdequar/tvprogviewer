...
namespace TVProgViewer.Services.Shipping
{
    ...
    public partial class ShipmentService : IShipmentService
    {
        ...
        public virtual IPagedList<Shipment> GetAllShipments(long vendorId = 0, long warehouseId = 0,
        ...
        /// <returns>Shipments</returns>
        public virtual IList<Shipment> GetShipmentsByIds(long[] shipmentIds)
        {
        ...
        public virtual Shipment GetShipmentById(long shipmentId)
        {
            if (shipmentId == 0)
                return null;
        ...
        public virtual IList<Shipment> GetShipmentsByOrderId(long orderId, bool? shipped = null, long vendorId = 0)
        {
            if (orderId == 0)
                return new List<Shipment>();
        ...
        public virtual IList<ShipmentItem> GetShipmentItemsByShipmentId(long shipmentId)
        {
            if (shipmentId == 0)
                return null;
        ...
        public virtual ShipmentItem GetShipmentItemById(long shipmentItemId)
        {
            if (shipmentItemId == 0)
                return null;
        ...
        public virtual int GetQuantityInShipments(Product product, long warehouseId,
