...
namespace TVProgViewer.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        {
            var allCacheKey = _staticCacheManager.PrepareKeyForDefaultCache(TvProgCatalogDefaults.ProductAttributeMappingsByProductCacheKey, productId);
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(TvProgCatalogDefaults.ProductAttributeValuesByAttributeCacheKey, productAttributeMappingId);
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(TvProgCatalogDefaults.PredefinedProductAttributeValuesByAttributeCacheKey, productAttributeId);
        ...
        public virtual async Task<IList<ProductAttributeCombination>> GetAllProductAttributeCombinationsAsync(int productId)
        {
            ...
            var combinations = await _productAttributeCombinationRepository.GetAllAsync(query =>
            {
                return from c in query
                       ...
                       select c;
            }, cache => cache.PrepareKeyForDefaultCache(TvProgCatalogDefaults.ProductAttributeCombinationsByProductCacheKey, productId));
