...
namespace TVProgViewer.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        {
            var key = TvProgCatalogCachingDefaults.ProductAttributesAllCacheKey.FillCacheKey(pageIndex, pageSize);
        ...
        {
            var allCacheKey = TvProgCatalogCachingDefaults.ProductAttributeMappingsAllCacheKey.FillCacheKey(productId);
        ...
        {
            var key = TvProgCatalogCachingDefaults.ProductAttributeValuesAllCacheKey.FillCacheKey(productAttributeMappingId);
        ...
        {
            var key = TvProgCatalogCachingDefaults.PredefinedProductAttributeValuesAllCacheKey.FillCacheKey(productAttributeId);
        ...
        public virtual IList<ProductAttributeCombination> GetAllProductAttributeCombinations(int productId)
        {
            ...
            var key = TvProgCatalogCachingDefaults.ProductAttributeCombinationsAllCacheKey.FillCacheKey(productId);
