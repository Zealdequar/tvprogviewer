...
namespace TVProgViewer.Services.Catalog
{
    ...
    public partial class ManufacturerService : IManufacturerService
    {
            ...
            bool showHidden = false)
        {
            ...
            if (!showHidden && !_catalogSettings.IgnoreAcl)
            {
                ...
                query = from m in query
                        ...
                        where !m.SubjectToAcl || allowedUserRolesIds.Contains(acl.UserRoleId)
                        select m;
            }
        ...
        public virtual IList<int> GetAppliedManufacturerIds(Discount discount, User customer)
        {
            if (discount == null)
                throw new ArgumentNullException(nameof(discount));

            var discountId = discount.Id;
            var cacheKey = TvProgDiscountCachingDefaults.DiscountManufacturerIdsModelCacheKey.FillCacheKey(
                discountId,
            ...
            int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
        {
            ...
            var key = TvProgCatalogCachingDefaults.ProductManufacturersAllByManufacturerIdCacheKey.FillCacheKey(manufacturerId,
                showHidden, pageIndex, pageSize, _workContext.CurrentUser.Id, _storeContext.CurrentStore.Id);
            ...
            bool showHidden = false)
        {
            ...
            var key = TvProgCatalogCachingDefaults.ProductManufacturersAllByProductIdCacheKey.FillCacheKey(productId,
                showHidden, _workContext.CurrentUser, _storeContext.CurrentStore);
