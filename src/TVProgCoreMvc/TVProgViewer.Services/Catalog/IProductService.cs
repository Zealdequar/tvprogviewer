...
namespace TVProgViewer.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        IList<TierPrice> GetTierPrices(Product product, User customer, int storeId);
        ...
        /// <param name="quantity">Quantity</param>
        /// <returns>Tier price</returns>
        TierPrice GetPreferredTierPrice(Product product, User customer, int storeId, int quantity);
        ...
        IPagedList<ProductReview> GetAllProductReviews(int userId = 0, bool? approved = null,
