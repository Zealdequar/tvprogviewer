...
namespace TVProgViewer.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        Task<IList<TierPrice>> GetTierPricesAsync(Product product, User user, int storeId);
        ...
        /// <returns>Tier price</returns>
        Task<TierPrice> GetPreferredTierPriceAsync(Product product, User user, int storeId, int quantity);
        ...
        Task<IPagedList<ProductReview>> GetAllProductReviewsAsync(int userId = 0, bool? approved = null,
