...
namespace TVProgViewer.Services.Localization
{
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        {
            var key = TvProgLocalizationCachingDefaults.LocaleStringResourcesAllCacheKey.FillCacheKey(languageId);
            ...
            if (!loadPublicLocales.HasValue || _cacheManager.IsSet(key))
            {
                ...
                _cacheManager.Remove(TvProgLocalizationCachingDefaults.LocaleStringResourcesAllPublicCacheKey.FillCacheKey(languageId));
                _cacheManager.Remove(TvProgLocalizationCachingDefaults.LocaleStringResourcesAllAdminCacheKey.FillCacheKey(languageId));

                return rez;
            }

            //performance optimization of the site startup
            key = (loadPublicLocales.Value ? TvProgLocalizationCachingDefaults.LocaleStringResourcesAllPublicCacheKey : TvProgLocalizationCachingDefaults.LocaleStringResourcesAllAdminCacheKey).FillCacheKey(languageId);
            ...
            return _cacheManager.Get(key, () =>
            {
                ...
                var query = from l in _lsrRepository.Table
                            ...
                            where l.LanguageId == languageId
                            select l;
                query = loadPublicLocales.Value ? query.Where(r => !r.ResourceName.StartsWith(TVProgViewerLocalizationDefaults.AdminLocaleStringResourcesPrefix)) : query.Where(r => r.ResourceName.StartsWith(TVProgViewerLocalizationDefaults.AdminLocaleStringResourcesPrefix));
                return ResourceValuesToDictionary(query);
            });
        }
            ...
            bool logIfNotFound = true, string defaultValue = "", bool returnEmptyIfNotFound = false)
        {
            ...
            if (_localizationSettings.LoadAllLocaleRecordsOnStartup)
            {
                ...
                var resources = GetAllResourceValues(languageId, !resourceKey.StartsWith(TVProgViewerLocalizationDefaults.AdminLocaleStringResourcesPrefix, StringComparison.InvariantCultureIgnoreCase));
            ...
            {
                //gradual loading
                var key = TvProgLocalizationCachingDefaults.LocaleStringResourcesByResourceNameCacheKey.FillCacheKey(languageId, resourceKey);
        ...
        public virtual string ExportResourcesToXml(Language language)
        {
            ...
            using (var xmlWriter = new XmlTextWriter(stream, Encoding.UTF8))
            {
                ...
                xmlWriter.WriteAttributeString("SupportedVersion", TvProgVersion.CurrentVersion);
        ...
        public virtual void ImportResourcesFromXml(Language language, StreamReader xmlStreamReader, bool updateExistingResources = true)
        {
            ...
            //clear cache
            _cacheManager.RemoveByPrefix(TvProgLocalizationCachingDefaults.LocaleStringResourcesPrefixCacheKey);
        }
        ...
        public virtual string GetLocalizedEnum<TEnum>(TEnum enumValue, int? languageId = null) where TEnum : struct
        {
            ...
            //localized value
            var resourceName = $"{TVProgViewerLocalizationDefaults.EnumLocaleStringResourcesPrefix}{typeof(TEnum)}.{enumValue}";
        ...
        public virtual string GetLocalizedPermissionName(PermissionRecord permissionRecord, int? languageId = null)
        {
            ...
            //localized value
            var resourceName = $"{TVProgViewerLocalizationDefaults.PermissionLocaleStringResourcesPrefix}{permissionRecord.SystemName}";
            var result = GetResource(resourceName, languageId ?? _workContext.WorkingLanguage.Id, false, string.Empty, true);
            ...
            where TPlugin : IPlugin
        {
            ...
            //localized value
            var resourceName = $"{TVProgViewerLocalizationDefaults.PluginNameLocaleStringResourcesPrefix}{systemName}";
