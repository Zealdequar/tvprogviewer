    ...
    public partial class VendorAttributeService : IVendorAttributeService
    {
        ...
        public virtual IList<VendorAttribute> GetAllVendorAttributes()
        {
            return _vendorAttributeRepository.Table
                ...
                .ToCachedList(TvProgVendorsCachingDefaults.VendorAttributesAllCacheKey);
        }
        ...
        {
            var key = TvProgVendorsCachingDefaults.VendorAttributeValuesAllCacheKey.FillCacheKey(vendorAttributeId);
