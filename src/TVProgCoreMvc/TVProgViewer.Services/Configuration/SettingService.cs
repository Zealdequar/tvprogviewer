...
namespace TVProgViewer.Services.Configuration
{
    ...
    public partial class SettingService : ISettingService
    {
        ...
        {
            //cache
            return _cacheManager.Get(TvProgConfigurationCachingDefaults.SettingsAllAsDictionaryCacheKey, () =>
            {
        ...
        public virtual IList<Setting> GetAllSettings()
        {
            var query = from s in _settingRepository.Table
                        ...
                        select s;
            var settings = query.ToCachedList(TvProgConfigurationCachingDefaults.SettingsAllCacheKey);
            return settings;
        }
        ...
        {
            _cacheManager.RemoveByPrefix(TvProgConfigurationCachingDefaults.SettingsPrefixCacheKey);
        }
