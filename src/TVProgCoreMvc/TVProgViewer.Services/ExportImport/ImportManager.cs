...
namespace TVProgViewer.Services.ExportImport
{
    ...
    public partial class ImportManager : IImportManager
    {
        ...
        protected virtual void ImportProductAttribute(PropertyManager<ExportProductAttribute> productAttributeManager, Product lastLoadedProduct)
        {
            ...
            var UserEntersQty = productAttributeManager.GetProperty("UserEntersQty").BooleanValue;
        ...
        private ImportProductMetadata PrepareImportProductData(ExcelWorksheet worksheet)
        {
            ...
            var productAttributeProperties = new[]
            {
                ...
                new PropertyByName<ExportProductAttribute>("UserEntersQty"),
        ...
        public virtual void ImportProductsFromXlsx(Stream stream)
        {
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                //activity log
                _UserActivityService.InsertActivity("ImportProducts", string.Format(_localizationService.GetResource("ActivityLog.ImportProducts"), metadata.CountProductsInFile));
            }
        }
        ...
        public virtual int ImportStatesFromTxt(Stream stream)
        {
            ...
            //activity log
            _UserActivityService.InsertActivity("ImportStates",
        ...
        public virtual void ImportManufacturersFromXlsx(Stream stream)
        {
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                //activity log
                _UserActivityService.InsertActivity("ImportManufacturers",
        ...
        public virtual void ImportCategoriesFromXlsx(Stream stream)
        {
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                //activity log
                _UserActivityService.InsertActivity("ImportCategories",
