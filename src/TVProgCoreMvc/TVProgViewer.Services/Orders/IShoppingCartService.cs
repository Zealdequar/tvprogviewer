...
namespace TVProgViewer.Services.Orders
{
    ...
    public partial interface IShoppingCartService
    {
        ...
        IList<string> GetRequiredProductWarnings(User User, ShoppingCartType shoppingCartType, Product product,
        ...
        IList<ShoppingCartItem> GetShoppingCart(User User, ShoppingCartType? shoppingCartType = null,
        ...
        /// <returns>Warnings</returns>
        IList<string> GetShoppingCartItemAttributeWarnings(User User,
        ...
        /// <param name="addRequiredProducts">Whether to add required products</param>
        /// <returns>Warnings</returns>
        IList<string> AddToCart(User user, Product product,
        ...
        /// <param name="resetCheckoutData">A value indicating whether to reset checkout data</param>
        /// <returns>Warnings</returns>
        IList<string> UpdateShoppingCartItem(User User,
        ...
        void MigrateShoppingCart(User fromUser, User toUser, bool includeCouponCodes);
