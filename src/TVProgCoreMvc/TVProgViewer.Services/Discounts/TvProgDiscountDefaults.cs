...
namespace TVProgViewer.Services.Discounts
{
    public static partial class TvProgDiscountDefaults
    {
        ...
        /// {0} : discount id
        /// </remarks>
        public static CacheKey DiscountRequirementsByDiscountCacheKey => new CacheKey("TvProg.discountrequirement.bydiscount.{0}");
        ...
        /// {2} : discount name
        /// </remarks>
        public static CacheKey DiscountAllCacheKey => new CacheKey("TvProg.discount.all.{0}-{1}-{2}", TvProgEntityCacheDefaults<Discount>.AllPrefix);
        ...
        /// {2} : current store ID
        /// </remarks>
        public static CacheKey CategoryIdsByDiscountCacheKey => new CacheKey("TvProg.discount.categoryids.bydiscount.{0}-{1}-{2}", CategoryIdsByDiscountPrefix, CategoryIdsPrefix);
        ...
        /// {2} : current store ID
        /// </remarks>
        public static CacheKey ManufacturerIdsByDiscountCacheKey => new CacheKey("TvProg.discount.manufacturerids.bydiscount.{0}-{1}-{2}", ManufacturerIdsByDiscountPrefix, ManufacturerIdsPrefix);
