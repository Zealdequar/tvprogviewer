...
namespace TVProgViewer.Services.Discounts
{
    ...
    public partial class DiscountService : IDiscountService
    {
            ...
            DateTime? startDateUtc = null, DateTime? endDateUtc = null)
        {
            ...
            var cacheKey = TvProgDiscountCachingDefaults.DiscountAllCacheKey
        ...
        public virtual DiscountValidationResult ValidateDiscount(Discount discount, User User, string[] couponCodesToValidate)
        {
            ...
            var key = TvProgDiscountCachingDefaults.DiscountRequirementModelCacheKey.FillCacheKey(discount);
