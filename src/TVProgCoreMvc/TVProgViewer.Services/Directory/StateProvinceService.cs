...
namespace TVProgViewer.Services.Directory
{
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        public virtual StateProvince GetStateProvinceByAbbreviation(string abbreviation, int? countryId = null)
        {
            ...
            var key = TvProgDirectoryCachingDefaults.StateProvincesByAbbreviationCacheKey.FillCacheKey(abbreviation,
                countryId ?? 0);
        ...
        {
            var key = TvProgDirectoryCachingDefaults.StateProvincesByCountryCacheKey.FillCacheKey(countryId, languageId, showHidden);
        ...
        public virtual IList<StateProvince> GetStateProvinces(bool showHidden = false)
        {
            var query = from sp in _stateProvinceRepository.Table
                        ...
                        select sp;
            var stateProvinces = query.ToCachedList(TvProgDirectoryCachingDefaults.StateProvincesAllCacheKey.FillCacheKey(showHidden));
            return stateProvinces;
        }
