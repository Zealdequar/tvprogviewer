    ...
    public partial class MeasureService : IMeasureService
    {
        ...
        public virtual IList<MeasureDimension> GetAllMeasureDimensions()
        {
            var query = from md in _measureDimensionRepository.Table
                ...
                select md;
            var measureDimensions = query.ToCachedList(TvProgDirectoryCachingDefaults.MeasureDimensionsAllCacheKey);
            ...
            MeasureDimension sourceMeasureDimension)
        {
            ...
            if (exchangeRatio == decimal.Zero)
                throw new TvProgException($"Exchange ratio not set for dimension [{sourceMeasureDimension.Name}]");
            ...
            MeasureDimension targetMeasureDimension)
        {
            ...
            if (exchangeRatio == decimal.Zero)
                throw new TvProgException($"Exchange ratio not set for dimension [{targetMeasureDimension.Name}]");
            result = result * exchangeRatio;
        ...
        public virtual IList<MeasureWeight> GetAllMeasureWeights()
        {
            var query = from mw in _measureWeightRepository.Table
                ...
                select mw;
            var measureWeights = query.ToCachedList(TvProgDirectoryCachingDefaults.MeasureWeightsAllCacheKey);
        ...
        public virtual decimal ConvertToPrimaryMeasureWeight(decimal value, MeasureWeight sourceMeasureWeight)
        {
            ...
            if (exchangeRatio == decimal.Zero)
                throw new TvProgException($"Exchange ratio not set for weight [{sourceMeasureWeight.Name}]");
            result = result / exchangeRatio;
            ...
            MeasureWeight targetMeasureWeight)
        {
            ...
            if (exchangeRatio == decimal.Zero)
                throw new TvProgException($"Exchange ratio not set for weight [{targetMeasureWeight.Name}]");
            result = result * exchangeRatio;
