...
namespace TVProgViewer.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        {
            var key = TvProgDirectoryCachingDefaults.CountriesAllCacheKey.FillCacheKey(languageId, showHidden);
        ...
        public virtual Country GetCountryByTwoLetterIsoCode(string twoLetterIsoCode)
        {
            ...
            var key = TvProgDirectoryCachingDefaults.CountriesByTwoLetterCodeCacheKey.FillCacheKey(twoLetterIsoCode);
        ...
        public virtual Country GetCountryByThreeLetterIsoCode(string threeLetterIsoCode)
        {
            ...
            var key = TvProgDirectoryCachingDefaults.CountriesByThreeLetterCodeCacheKey.FillCacheKey(threeLetterIsoCode);
