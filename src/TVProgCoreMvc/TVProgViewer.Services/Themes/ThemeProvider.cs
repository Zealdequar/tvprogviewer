...
namespace TVProgViewer.Services.Themes
{
    /// <summary>
    ...
    public partial class ThemeProvider : IThemeProvider
    {
        ...
        public ThemeProvider(ITvProgFileProvider fileProvider)
        {
        ...
        public IList<ThemeDescriptor> GetThemes()
        {
            ...
            var themeDirectoryPath = _fileProvider.MapPath(TvProgPluginDefaults.ThemesPath);
            foreach (var descriptionFile in _fileProvider.GetFiles(themeDirectoryPath, TvProgPluginDefaults.ThemeDescriptionFileName, false))
            {
