...
namespace TVProgViewer.TVProgUpdaterV2.Mvc.Routing
{
    /// <summary>
    /// Represents custom overridden redirect result executor
    /// </summary>
    public class TvProgRedirectResultExecutor : RedirectResultExecutor
    {
        #region Fields
        ...
        public TvProgRedirectResultExecutor(ILoggerFactory loggerFactory, 
