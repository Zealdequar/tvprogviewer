...
using TVProgViewer.TVProgUpdaterV2.Mvc.Filters;
using TVProgViewer.TVProgUpdaterV2.UI;
...
namespace TVProgViewer.TVProgUpdaterV2.Controllers
{
    ...
    public abstract class BaseController : Controller
    {
        ...
        public virtual void SaveSelectedCardName(string cardName, bool persistForTheNextRequest = true)
        {
            ...
            //"GetSelectedCardName" method of \TvProg.TVProgUpdaterV2\Extensions\HtmlExtensions.cs
        ...
        {
            //keep this method synchronized with
            //"GetSelectedTabName" method of \TvProg.TVProgUpdaterV2\Extensions\HtmlExtensions.cs
