...
using TVProgViewer.TVProgUpdaterV2.Events;
using TVProgViewer.TVProgUpdaterV2.Models;

namespace TVProgViewer.TVProgUpdaterV2.Components
{
    /// <summary>
    ...
    public abstract class TvProgViewComponent : ViewComponent
    {
        private void PublishModelPrepared<TModel>(TModel model)
        {
            ...
            //as we do in the /TvProg.TVProgUpdaterV2/Mvc/Filters/PublishModelEventsAttribute.cs for controllers
